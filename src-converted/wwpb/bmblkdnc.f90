...
! Default host tree species is now turned OFF.  User must define via keyword!
!
!  Klamath (NC) FVS species are:   OC SP DF WF  M IC BO TO RF PP OTH
!
...
! Klamath FVS species are:
!                 OC SP DF WF  M IC BO TO RF PP OTH
DATA ISPFLL /3, 2, 3, 3, 2, 3, 2, 2, 3, 2, 2/

! Note: above falldown rates arbitrarily assigned by Andrew McMahan 5/31/05
! using data from table 4.12.3 FFE addendum (Reinhardt and Crookston, 2005)  If
