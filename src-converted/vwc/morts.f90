...
!  TREE RECORD.  MORTALITY RATE FOR LARGE TREES IS PREDICTED FROM DBH,
!  CROWN RATIO, SITE INDEX, AND BASAL AREA INTREES LARGER. IF STAND GETS
!  ABOVE MAXSDI IT WILL APPLY RATE UNTIL STAND IS BELOW MAX. IF THIS
!  ROUTINE IS CALLED FROM **TREGRO** WHEN CYCLING FOR GROWTH PREDICTION.
!  ENTRY **MORCON** IS ACCESSED TO LOAD SITE DEPENDENT CONSTANTS.
!----------
...
! IF USERS WANTS TO TEST SMC EQUATION FOR DF SEE COMMENTED OUT
...
XSITE1=SITEAR(16)
!----------
! IN WC CONVERT CURTIS SI TO KING SI
!----------
IF (VARACD.EQ.'WC') XSITE1=5.21486+0.66486*SITEAR(16)
!
...
!     THAT STANDS DO NOT EXCEED MAXIMUM BA AND SDI.
