...
!.... No check for debug.
!.... This routine is called before any keywords are processed.
!.... So, no call to DBCHK would work.
...
!     INITIALIZE THE BIOLOGICAL CONTROL AGENTS
...
!.... Initial new spread and intensification model
