...
!     given standardized errors at 1 or 2 heights besides BH, perform
...
!     ZEX    Input   R*4()   Standardized errors at those heights.
...
!            write(*,1) NEXTRA
!1           format(' Subroutine SF_3z given invalid NEXTRA value =',i4/
