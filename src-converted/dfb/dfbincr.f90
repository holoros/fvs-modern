...
!     Date of previous revision was 12/14/95.
...
!
!     IFVSSP CAN BE MODIFIED FOR DIFFERENT VARIANTS OF FVS SO
!     THAT SPECIES MATCH BETWEEN FVS AND THE DOUGLAS-FIR BEETLE
!     MODEL.
!
!     FOR CENTRAL ROCKIES VARIANT (CR) SET THE SPECIES MAPPING
!     ARRAY IFVSSP BASED ON THE MODEL TYPE.  IN THE OTHER
!     VARIANTS OF FVS IFVSSP IS SET IN THE VARIANT DEPENDENT
!     SUBROUTINE DFBLKD.
!
...
IF (KODTYP .EQ. 1) THEN
!
!        SOUTHWEST MIXED CONIFER MODEL TYPE.
!
   IFVSSP(1)  =  1
   IFVSSP(2)  = 17
   IFVSSP(3)  =  3
...
!
!        SOUTHWEST PONDEROSA PINE MODEL TYPE.
!
   IFVSSP(1)  =  1
   IFVSSP(2)  = 17
   IFVSSP(3)  =  3
...
!
!        BLACK HILLS PONDEROSA PINE MODEL TYPE.
!
   IFVSSP(1)  = 24
   IFVSSP(2)  = 17
   IFVSSP(3)  =  3
