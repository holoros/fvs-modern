...
!      JFOR = FOREST CODE
!             1 IS GIFFORD PINCHOT (603)
!             2 IS MT BAKER / SNOQUALMIE (605)
!             3 IS MT HOOD (606)
!             4 IS ROGUE RIVER (610)
!             5 IS UMPQUA (615)
!             6 IS WILLAMETTE (618)
!             7 IS BLM SALEM --- USE MT HOOD
!             8 IS BLM EUGENE --- USE WILLAMETTE
!             9 IS BLM ROSEBURG --- USE UMPQUA
!            10 IS BLM MEDFORD --- USE ROGUE RIVER
...
!
! SPECIES ORDER IN WC VARIANT:
!    1 = ABAM     PACIFIC SILVER FIR        ABIES AMABILIS
!    2 = ABCO     WHITE FIR                 ABIES CONCOLOR
!    3 = ABGR     GRAND FIR                 ABIES GRANDIS
!    4 = ABLA     SUBALPINE FIR             ABIES LASIOCARPA
!    5 = ABMA     CALJFORNIA RED FIR        ABIES MAGNIFICA
!    6 =
!    7 = ABPR     NOBLE FIR                 ABIES PROCERA
!    8 = CANO9    ALASKA CEDAR              CALLITROPSIS NOOTKATENSIS
!        LAOC     WESTERN LARCH             LARIX OCCIDENTALIS
!    9 = LIDE     INCENSE CEDAR             LIBOCEDRUS DECURRENS
!   10 = PIEN     ENGELMANN SPRUCE          PICEA ENGELMANNII
!        PISI     SITKA SPRUCE              PICEA SITCHENSIS
!   11 = PICO     LODGEPOLE PINE            PINUS CONTORTA
!   12 = PIJE     JEFFREY PINE              PINUS JEFFREYI
!   13 = PILA     SUGAR PINE                PINUS LAMBERTIANA
!   14 = PIMO3    WESTERN WHITE PINE        PINUS MONTICOLA
!   15 = PIPO     PONDEROSA PINE            PINUS PONDEROSA
!   16 = PSME     DOUGLAS-FIR               PSEUDOTSUGA MENZIESII
!   17 = SESE3    COAST REDWOOD             SEQUOIA SEMPERVIRENS
!   18 = THPL     WESTERN REDCEDAR          WESTERN REDCEDAR
!   19 = TSHE     WESTERN HEMLOCK           TSUGA HETEROPHYLLA
!   20 = TSME     MOUNTAIN HEMLOCK          TSUGA MERTENSIANA
!   21 = ACMA3    BIGLEAF MAPLE             ACER MACROPHYLLUM
!   22 = ALRU2    RED ALDER                 ALNUS RUBRA
!   23 = ALRH2    WHITE ALDER               ALNUS RHOMBIFOLIA
!        ARME     PACIFIC MADRONE           ARBUTUS MENZIESII
!   24 = BEPA     PAPER BIRCH               BETULA PAPYRIFERA
!   25 = CHCHC4   GIANT CHINQUAPIN          CHRYSOLEPIS CHRYSOPHYLLA
!        LIDE3    TANOAK                    LITHOCARPUS DENSIFLORUS
!   26 = POTR5    QUAKING ASPEN             POPULUS TREMULOIDES
!   27 = POBAT    BLACK COTTONWOOD          POPULUS TRICHOCARPA
!   28 = QUGA4    OREGON WHITE OAK          QUERCUS GARRYANA
!        QUKE     CALJFORNIA BLACK OAK      QUERCUS KELLOGGII
!   29 = JUOC     JUNIPER                   JUNIPERUS OCCIDENTALIS
!   30 = LALY     SUBALPINE LARCH           LARIX LYALLII
!   31 = PIAL     WHITEBARK PINE            PINUS ALBICAULIS
!   32 = PIAT     KNOBCONE PINE             PINUS ATTENUATA
!   33 = TABR2    PACIFIC YEW               TAXUS BREVIFOLIA
!   34 = CONU4    PACIFIC DOGWOOD           CORNUS NUTTALLII
!   35 = CR__     HAWTHORN                  CRATAEGUS spp.
!   36 = PREM     BITTER CHERRY             PRUNUS EMARGINATA
!   37 = SA__     WILLOW                    SALIX spp.
!   38 =          nothing
!   39 =          OTHER
!----------
!
...
DATA (GIFFPC(I,1),I=1,39)/ &
     ...
     452.3985,  595.1068,  531.0073,  465.0811,  368.3722, &
...
DATA (GIFFPC(I,2),I=1,39)/ &
       ...
       5.9690,    5.8103,    5.9643,    6.4772,    6.8267, &
...
DATA (GIFFPC(I,3),I=1,39)/ &
      ...
      -0.4910,   -0.3821,   -0.4083,   -0.4941,   -0.5070, &
...
DATA (MTBSNQ(I,1),I=1,39)/ &
     ...
     536.7368,  595.1068,  422.9704,  319.3737,  547.9487, &
...
DATA (MTBSNQ(I,2),I=1,39)/ &
      ...
      12.6623,    7.6616,    5.7025,    6.3318,    6.6981, &
       5.5803,    5.8103,    5.7344,    6.3962,    7.1372, &
...
DATA (MTBSNQ(I,3),I=1,39)/ &
      ...
      -0.4101,   -0.3821,   -0.4267,   -0.5698,   -0.4220, &
...
DATA (ROGRIV(I,1),I=1,39)/ &
     ...
     540.9410,  595.1068,  617.7622,  263.1274,  233.6987, &
...
DATA (ROGRIV(I,2),I=1,39)/ &
       ...
       5.6796,    5.8103,    5.5213,    6.9356,    6.9059, &
...
DATA (ROGRIV(I,3),I=1,39)/ &
      ...
      -0.4037,   -0.3821,   -0.3508,   -0.6619,   -0.6166, &
...
DATA (UMPQUA(I,1),I=1,39)/ &
     ...
     316.1283,  595.1068,  617.7622,  608.6098,  393.9809, &
...
DATA (UMPQUA(I,2),I=1,39)/ &
       ...
       5.9659,    5.8103,    5.5213,    6.0875,    6.3930, &
...
DATA (UMPQUA(I,3),I=1,39)/ &
      ...
      -0.5748,   -0.3821,   -0.3508,   -0.4163,   -0.4751, &
