...
!         western redcedar (from NI, which uses DF for some RC attributes)
    CASE (7)
      V2T(I)     =  19.3
      LEAFLF(I)  =   5.0
      TFALL(I,3) =  20.0
...
!         western larch (from NI, which uses similarity to PP for some WL attributes)
    CASE (8)
      V2T(I)     =  29.9
      LEAFLF(I)  =   1.0
      TFALL(I,3) =  15.0
...
!         lodgepole pine & 'other' softwoods
    CASE (11,37)
      V2T(I)     =  23.7
      LEAFLF(I)  =   3.0
      TFALL(I,3) =  15.0
...
!         pinyon pine, singleleaf pinyon, border pinyon, Arizona pinyon
    CASE (12,33:35)
      V2T(I)     =  31.8
      LEAFLF(I)  =   3.0
      TFALL(I,3) =  15.0
