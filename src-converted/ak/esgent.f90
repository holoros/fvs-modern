...
IMPLICIT NONE
!----------
! ESTB $Id: esgent.f 2448 2018-07-10 17:04:02Z gedixon $
!----------
!     USES REGENT TO ADD HEIGHT INCREMENT TO REGENERATED TREES
!     DIFFERS FROM ESTB/ESGENT.F AT DBH ASSIGNED TO TREES AT HEIGHT
!     MAXIMUM: 0.95 INSTEAD OF 2.95. THIS MATCHES SMALL TREE/LARGE
!     TREE SIZES IN AK VARIANT
!
!OMMONS
!
!
