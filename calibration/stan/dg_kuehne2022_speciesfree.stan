// ============================================================================
// dg_kuehne2022_speciesfree.stan  (B1 — species-free trait-driven form)
//
// FVS-CONUS diameter growth, Kuehne et al. 2022 form, species-free variant.
//
// Companion to hg_organon_speciesfree.stan. Derived from
// dg_kuehne2022_lognormal.stan (v3 traits-as-fixed-effects form) by removing
// the species random intercept entirely:
//   - z_sp removed from eta and eta_gq
//   - sigma_sp and z_sp_raw parameters dropped
//   - trait_effect = W * gamma is the only species-level signal
//
// Hypothesis: with 75 species and 8 trait coefficients, the trait fixed
// effects fully replace the residual species RE that v3 had. If this fit's
// sigma is within ~5% of the v3 sigma (banked May 7), species-free is
// validated on DG_Kue the same way it was validated on HG.
//
...
parameters {
  ...
  // sigma_sp and z_sp_raw removed (species-free)
...
transformed parameters {
  // Traits as fixed effects: this is the ONLY species signal
