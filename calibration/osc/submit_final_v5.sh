...
#SBATCH --mem=48G
#SBATCH --output=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/final_v5_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/final_v5_%j.err
