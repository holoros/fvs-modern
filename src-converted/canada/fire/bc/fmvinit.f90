...
!     Annual decay rates (proportion lost/yr) are taken from Kurz et al. 2009
!     Ecological Modelling 220: 480-504, Table 4
!     LITTER ... AG very fast
!     DUFF ... BG slow
!----------
DO J = 1,4
...
!
!----------
!     CFIM INITIALIZATIONS
!----------
!     SET TO TRUE VIA KEYWORD ONLY
CFIM_ON = .FALSE.
!     BULK DENSITY
CFIM_BD = 80.0
!     DROUGHT CODE
CFIM_DC = 300.0
!     fuel_density(kg/m^3)                rho_surf     398.0
CFIM_INPUT(17) = 398.0
!     surface_area_to_volume_ratio(1/m)   sigma_surf   3092.0
CFIM_INPUT(16) = 3092
!     surface_area_to_volume_ratio(1/m)   sigma_can    5401.0
CFIM_INPUT(19) = 5401.0
!     canopy_fuel_particle_diameter(m)    diameter        0.00074
CFIM_INPUT(21) = 0.00074
!     canopy_fuel_particle_length(m)      length          0.10
CFIM_INPUT(23) = 0.10
!     time_step(s)                        tstep           1
CFIM_INPUT(7) = 1.0
!     iterations                          iters         150
CFIM_INPUT(8) = 150.0
!     x_starting_position(m)              xstart          8.0
CFIM_INPUT(9) = 8.0
!----------
!     END OF CFIM INITIALIZATIONS
!----------
RETURN
END
