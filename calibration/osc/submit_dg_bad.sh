...
#SBATCH --array=0-2
#SBATCH --output=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/dg_bad_%a_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/dg_bad_%a_%j.err
