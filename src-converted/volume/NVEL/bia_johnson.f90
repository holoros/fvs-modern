...
!     CALCULATE CU FT VOL WITH JOHNSON'S FORM CLASS FORMULA

!     Note: there used to be a long set of code to calculate Form
!     Class.  This needs to be calculated BEFORE coming to this
!     subroutine
  MinCUFTDBH = 1.0
