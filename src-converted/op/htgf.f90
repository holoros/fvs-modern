...
! DEBUG
    IF(DEBUG)WRITE(JOSTND,*)'IN HTGF - RW/GS DEBUG',' D=', D, &
       ' H=',H,' SI=',SINDX,' DGLT=', DGLT,' HTG5YR=',HTG(I)
...
!----------
    ...
    IF(H .GT.HTMAX) THEN
      IF(H .GE. HTMAX2) THEN
        ...
        IF(DEBUG)WRITE(JOSTND,*)' I,ISPC,H,HTMAX2,HTG,SCALE,', &
                    'XHT,HTCON= ',I,ISPC,H,HTMAX2,HTG(I),SCALE, &
                     XHT,HTCON(ISPC)
      ENDIF
      GO TO 161
    END IF
