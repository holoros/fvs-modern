...
!     ICASCA FVS species:          PC IC RC WF RF SH DF WH MH WB KP
!                                  LP CP LM JP SP WP PP MP GP JU BR
!                                  GS PY OS LO CY BL EO WO BO VO IO
!                                  BM BU RA MA GC DG FL WN TO SY AS
!                                  CW WI CN CL OH
...
! ICASCA FVS species are:
!
!                 PC IC RC WF RF SH DF WH MH WB KP
!                 LP CP LM JP SP WP PP MP GP JU BR
!                 GS PY OS LO CY BL EO WO BO VO IO
!                 BM BU RA MA GC DG FL WN TO SY AS
!                 CW WI CN CL OH
...
! using data from table 4.13.3 FFE addendum (Reinhardt and Crookston, 2005)  If
! the falldown multipliers in FFE addendum were greater than 1, then herein the
! species is assigned a "medium" falldown rate.  Otherwise "slow".
