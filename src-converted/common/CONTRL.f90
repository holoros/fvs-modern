...
!
      REAL    AUTEFF,AUTMAX,AUTMIN,BAMAX,BAMIN,BFMIN,CCCOEF,CCCOEF2, &
              ...
              FINTM,PBAWT,PCCFWT,PTPAWT,SCFMIN,SPCLWT,TCFMIN,TCWT,TRM, &
              YR, ATDR016, ODR016
!
...
!  ATDR016  -- AFTER THINNING REINEKE DIAMETER CALCULATED USING ZEIDE METHOD
!   ODR016  -- REINEKE DIAMETER CALCULATED USING ZEIDE METHOD,
!              AT END OF PREVOIUS CYCLE
