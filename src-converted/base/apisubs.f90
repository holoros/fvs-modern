...
!     the shared library version of FVS. Other routines that exist
!     inside FVS may also be called.

!     Created in late 2011 by Nick Crookston, RMRS-Moscow
...
!     set and/or gets the named tree attributes
!     name    = char string of the variable name, (case sensitive)
!     nch     = the number of characters in "name"
!     action  = char string that is one of "set" or "get" (case sensitive)
!     ntrees  = the number of trees, length of attr
!     attr    = a vector of length ntrees, always "double"
!     rtnCode = 0 is OK, 1= "name" not found,
!               2= ntrees is greater than maxtrees, not all data transfered
!               3= there were more/fewer than ntrees.
!               4= the length of the "name" string was too big or small
!
include "PRGPRM.f90"
include "FMPARM.f90"
include "FMCOM.f90"
...
!     set and/or gets the named species attributes
!     name    = char string of the variable name, (case sensitive)
!     nch     = the number of characters in "name"
!     action  = char string that is one of "set" or "get" (case sensitive)
!     attr    = a vector of length data, always "double"
!     rtnCode = 0 is OK, 1= "name" not found,
!               4= the length of the "name" string was too big or small
!
include "PRGPRM.f90"
...
!     volume calculation-related vectors
...
!     action  = char string that is one of "set" or "get" (case sensitive)
!     attr    = a vector of length data, always "double"
!     rtnCode = 0 is OK, 1=action is "get" and variable
!               is known to be undefined. 2= "name" not found,
!
include "PRGPRM.f90"
include "FMPARM.f90"
include "FMCOM.f90"
...
!     rtnCode = 0 when all is OK
!               1 when there is no room for the ntrees
!                 or when ntrees is zero
...
!     from within FVS. nch is the length of filename.
...
!     set and/or gets the named SVS object attributes
!     name    = char string of the variable name, (case sensitive)
!     nch     = the number of characters in "name"
!     action  = char string that is one of "set" or "get" (case sensitive)
!     nobjs   = the number of objects, length of data
!     attr    = a vector of length data, always "double"
!     rtnCode = 0 is OK,
!               1= "name" not found,
!               2= nobjs is greater than the corresponding max, no data transfered.
!               3= there were more/fewer than nobjs.
!               4= the length of the "name" string was too big or small
...
!     ALL object section (the locations, etc):
...
!     set and/or gets the named FFE variables
!     name    = char string of the variable name, (case sensitive)
!     nch     = the number of characters in "name"
!     action  = char string that is one of "set" or "get" (case sensitive)
!     nobjs   = the number of objects, length of data
