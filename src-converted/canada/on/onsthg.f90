...
! CANADA-ON $Id$
!----------
!  THIS SUBROUTINE COMPUTES ANNUAL HEIGHT INCREMENTS FOR
!  SMALL TREES.  THE HEIGHT INCREMENT MODEL IS INTNDED FOR TREES
!  THAT ARE LESS THAN 12 CM DBH
!----------
!OMMONS
!
INCLUDE 'PRGPRM.f90'
...
!     OUTPUT:
!     HTG  = REAL annual height growth (ft)
!
!     INPUT:
!     ISPC = INT Species # (MAXSP)
!     D    = REAL Current diameter (in)
!     HT   = REAL Current height (ft)
!     SI   = REAL Site Index (ft)
!     BAL  = REAL Basal area of trees larger than "me" (ft**2/ac)
...
!     MAPPING OF FVS SPECIES INTO ONTARIO GROWTH SPECIES.
