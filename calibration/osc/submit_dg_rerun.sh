...
#SBATCH --array=0-6
#SBATCH --output=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/dg_v2_%a_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/dg_v2_%a_%j.err
