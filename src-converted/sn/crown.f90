...
!----------
!----------
!  MEAN CROWN RATIO MODEL FUNCTIONS ARE SPECIES DEPENDENT
!----------
!     MCREQN  -- PARAMETERS USED TO CALCULATE MEAN CROWN RATIO (MCR)
!                MCREQN(6,MAXSP)
!                MCREQN(1,MAXSP) = 1.0  HRCL HOERL'S EQUATION
!                MCREQN(1,MAXSP) = 2.0  PWR POWER EQUATION
!                MCREQN(1,MAXSP) = 3.0  LIN LINEAR EQUATION
!                MCREQN(1,MAXSP) = 4.0  LOG LOGARITHMIC EQUATION
!                MCREQN(1,MAXSP) = 5.0  INVERSE OR HYPERBOLIC EQUATION
!
!
!OMMONS
!
...
REAL CR,CL,HD,HN,CRMAX,CRLN,PDIFPY,CHG,D
DATA MYACTS/81/
!-----------
...
!----------
!  SELECT THE APPROPRIATE FUNCTION BY SPECIES TO CALCULATE THE
!  MEAN CROWM RATIO (ACRNEW) FROM RSDI
!---------
...
500 CONTINUE
!----------
!  INVERSE OR HYPERBOLIC EQUATION
!----------
AMCR= MCREQN(2,ISPC)
BMCR= MCREQN(6,ISPC)
!
...
!  THIS WAS TAKEN OUT FOR THE SN VARIANT
!----------
...
74 CONTINUE
!----------
!  DUB MISSING CROWNS ON CYCLE0.00DEAD TREES.
!----------
...
!----------
!     MCREQN  -- PARAMETERS USED TO CALCULATE MEAN CROWN RATIO (MCR)
!                MCREQN(MAXSP,1) = 1.0  HRCL HOERL'S EQUATION
!                MCREQN(MAXSP,1) = 2.0  PWR POWER EQUATION
!                MCREQN(MAXSP,1) = 3.0  LIN LINEAR EQUATION
!                MCREQN(MAXSP,1) = 4.0  LOG LOGARITHMIC EQUATION
!                MCREQN(MAXSP,1) = 5.0  INVERSE OR HYPERBOLIC EQUATION
!                MCREQN(MAXSP,2) = a COEFFICIENT
!                MCREQN(MAXSP,3) = c COEFFICIENT
!                MCREQN(MAXSP,4) = b COEFFICIENT
!                MCREQN(MAXSP,5) = b COEFFICIENT IN LOG FUNCTION
!                MCREQN(MAXSP,6) = b COEFICIENT IN INVERSE FUNCTION
!
...
!----------
!  WIEBULL FUNCTION COEFFICIENTS
!  WEIBUL  -  ARRAY CONTAINING COEFFIECIENTS
!  WEIBUL(1,J) -- WEIBULL A COEFFICIENT
!  WEIBUL(2,J) -- B0 IN REGRESSION FOR WEIBUL B COEFF. B= B0+B1*MCR
!  WEIBUL(3,J) -- B1 IN REGRESSION FOR WEIBUL B COEFF. B= B0+B1*MCR
!  WEIBUL(4,J) -- WEIBULL C COEFFICIENT
!----------
!
