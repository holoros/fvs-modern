...
!
!     OLD LS VERSION SPECIES CODES
!     DATA JSP     /'JP ','SC ','RN ','RP ','WP ','WS ','NS ','BF ',
...
!
!     ONTARIO SPECIES CODES.
!        ADD IN THE FOUR NEW PLANTATION SPECIES
...
!
!=================================
!     SPECIES LIST FOR ONTARIO -
!=================================
!     1 = JACK PINE NATURAL (PJ)
!     2 = SCOTCH PINE (PS)
!     3 = RED PINE NATURAL (RN)
!     4 = PLANTED RED PINE (RP) (was red pine (plantation))
!     5 = EASTERN WHITE PINE NATURAL (PW)
!     6 = WHITE SPRUCE NATURAL (SW)
!     7 = NORWAY SPRUCE (SN)
!     8 = BALSAM FIR (BF)
!     9 = BLACK SPRUCE NATURAL (SB)
!    10 = TAMARACK (TA)
!    11 = NORTHERN WHITE-CEDAR (CE)
!    12 = EASTERN HEMLOCK (HE)
!    13 = OTHER SOFTWOOD SPECIES (SO)
!    14 = EASTERN REDCEDAR (CR)
!    15 = BLACK ASH (AB)
!    16 = GREEN ASH (AR)
!    17 = EASTERN COTTONWOOD (CW)
!    18 = SILVER MAPLE (MV)
!    19 = RED MAPLE (MR)
!    20 = BLACK CHERRY (CB)
!    21 = AMERICAN ELM (EW)
...
!    23 = ROCK ELM (ER)
!    24 = YELLOW BIRCH (BY)
!    25 = AMERICAN BASSWOOD (BD)
!    26 = SUGAR MAPLE (MH)
!    27 = BLACK MAPLE (MB)
!    28 = AMERICAN BEECH (BE)
!    29 = WHITE ASH (AW)
!    30 = WHITE OAK (OW)
!    31 = SWAMP WHITE OAK (OP)
!    32 = BUR OAK (OB)
!    33 = CHINKAPIN OAK (OC)
!    34 = NORTHERN RED OAK (OR)
!    35 = BLACK OAK (BO)
!    36 = NORTHERN PIN OAK (PN)
!    37 = BITTERNUT HICKORY (HB)
!    38 = PIGNUT HICKORY (HP)
!    39 = SHAGBARK HICKORY (HU)
!    40 = LARGETOOTH ASPEN (PG) (was bigtooth aspen)
!    41 = TREMBLING ASPEN (PT) (was quaking aspen)
!    42 = BALSAM POPLAR (PB)
!    43 = PAPER BIRCH (BW)
!    44 = COMMERCIAL HARDWOOD SPECIES (CH)
!    45 = BUTTERNUT (BT)
!    46 = BLACK WALNUT (WB)
!    47 = IRONWOOD (IW) (was eastern hophornbeam)
!    48 = BLACK LOCUST (LB)
!    49 = NON-COMMERCIAL HARDWOOD SPECIES (NC)
!    50 = BOXELDER (MM)
!    51 = STRIPED MAPLE (MS)
!    52 = MOUNTAIN MAPLE (MT)
!    53 = AMERICAN HORNBEAM (BB)
!    54 = AMERICAN CHESTNUT (CA)
!    55 = HACKBERRY (BH)
!    56 = FLOWERING DOGWOOD (DF)
...
!    65 = BLACK WILLOW (WI)
!    66 = DIAMOND WILLOW (WI)
!    67 = SASSAFRAS (SS)
!    68 = AMERICAN MOUNTAIN ASH (AM)
!    69 = PLANTED JACK PINE (JP) (was jack pine (plantation))
!    70 = PLANTED WHITE PINE (WP) (was white pine (plantation))
!    71 = PLANTED WHITE SPRUCE (SP) (was white spruce (plantation))
!    72 = PLANTED BLACK SPRUCE (BP) (was black spruce (plantation))

!----------
!  SIGMAR ARE THE ERROR TERMS FOR DIAMETER GROWTH.  THESE COEFFICIENTS
!  ARE THE ROOT MEAN SQUARE ERROR FOR EACH SPECIES.
!----------
