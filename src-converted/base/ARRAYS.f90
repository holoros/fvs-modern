...
! ABVGRD_BIO --TOTAL ABOVE GROUND BIOMASS PER TREE RECORD.
!              EQUATES TO DRYBIO POSITION 1 + POSITION 13
! ABVGRD_CARB--TOTAL ABOVE GROUND CARBON PER TREE RECORD.
!              DRYBIO POSITION 1 * CARB FACTOR + POSITION 13 * 0.5
!              COMPUTED IN VOLS.F
...
!              CALCULATED IN **VOLS**.
!      MCFV -- MERCHANTABLE CUBIC FOOT VOLUME PER TREE CALCULTED IN **VOLS**
!      SCFV -- SAWLOG CUBIC FOOT VOLUME PER TREE CALCULTED IN **VOLS**
!    DRYBIO -- DRYBIOMASS ARRAY CALCULATED IN FIAVBC **VOLS**
!      CULL -- PERCENTAGE OF ROTTEN OR MISSING CUBIC FOOT VOLUME
!    CRWDTH -- PREDICTED CROWN WIDTH. CALCULATED EACH CYCLE IN **CWIDTH**.
! CARB_FRAC -- CARBON FRACTION FOR TREE
! CUBSAW_BIO-- TOTAL CUBIC SAWTIMBER BIOMASS PER TREE RECORD
!              DRYBIO POSITION 6
! CUBSAW_CARB--CARBON CONTENT OF CUBSAW_BIO = CUBSAW_BIO * CARBON FACTOR
!              COMPUTED IN VOLS.F
...
!              CYCLE.
!   DECAYCD -- CODE INDICATIGN THE STAGE OF DECAY IN A STANDING DEAD TREE
!                CORRESPONDS TO FIA DATABASE DEFINITIONS:
!                1: ALL LIMBS AND BRANCHES ARE PRESENT.
!                   TOP OF CROWN STILL PRESENT
!                   ALL BARK REMAINS
!                   SAPWOOD INTACT WITH MINIMAL DECAY
!                   HEARTWOOD IS SOUND
!                2: FEW LIMBS AND NO FINE BRANCHES REMAIN
!                   TOP MAY BE BROKEN
!                   VARIABLE AMOUNT OF BARK REMAINS
!                   SAPWOOD IS SLOUGHING WITH ADVANCED DECAY
!                   HEARTWOOD IS SOUND AT BASE BUT DECAYING IN UPPER BOLE
!                3: ONLY LIMB STUBS REMAIN
!                   TOP IS BROKEN
!                   VARIABLE AMOUNT OF BARK REMAINS
!                   SAPWOOD IS SLOUGHING
!                   HEARTWOOD HAS ADVANCED DECAY IN UPPER BOLE, BEGINNING TO DECAY AT BASE
!                4: FEW TO NO LIMB STUBS REMAIN
!                   TOP IS BROKEN
!                   VARIABLE AMOUNT OF BARK REMAINS
!                   SAPWOOD IS SLOUGHING
!                   HEARTWOOD HAS ADVANCED DECAY AT THE BASE AND IS SLOUGHING IN UPPER BOLE
!                5: NO EVIDENCE OF BRANCHES REMAIN
!                   TOP IS BROKEN
!                   < 20% OF BARK REMAINS
!                   SAPWOOD IS GONE
...
!              SNAG VOLUME OR FROM FMCROWW. DO NOT LOAD HT2TD IN THAT CASE
...
!              USED IN ORGANON SWO AND NWO/SMC TO DEFINE THE VALUE "USER" IN
!              THE ORGANON CODE. ALSO USED TO HOLD THE FORM AND RISK CLASS
!              WHEN DAMAGE CODE 54 IS CODED (SET IN **DAMPRO**).
...
! MERCH_BIO -- TOTAL MERCHANTABLE BIOMASS PER TREE RECORD
!              DRYBIO POSITION 6 + POSITION 7
! MERCH_CARB-- CARBON CONTAINED IN MERCH_BIO
!              =MERCH_BIO * CARBON FACTOR
...
!  WDLDSTEM -- COORESPONDS TO WOODLAND SPECIES STEM COUNT IN FIA DATABASE
!              NUMBER OF LIVE AND DEAD STEMS USED TO CALCULATE DIAMETER
!              ON WOODLAND TREES
...
!              BOARD FOOT VOLUME.
!       WK7    WK7 REMOVED CUBIC SAWTIMBER VOLUME
!       WK8    WK8 REMOVED ABOVE GROUND BIOMASS
!       WK9    WK9 REMOVED ABOVE GROUND CARBON
!       WK10   WK10 REMOVED CUBIC MERCHANTABLE BIOMASS
!       WK11   WK11 REMOVED CUBIC MERCHANTABLE CARBON
!       WK12   WK12 REMOVED CUBIC SAWTIMBER BIOMASS
!       WK13   WK13 REMOVED CUBIC SAWTIMBER CARBON
!       WK14   WK14 REMOVED FOLIAR BIOMASS
!       WK15   WK15 REMOVED FOLIAR CARBON
