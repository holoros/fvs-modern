...
INTEGER   I,JROUT,DBSKODE,CRWNRTO
INTEGER   JS
REAL      VT, X, H, D
REAL      V(11)
REAL      ABIO, MBIO, RBIO
...
!     JUMP TO THE END IF REPORT BEGIN YEAR REMAINS 0.
!     THIS USED TO BE BASED ON A REPORTING PERIOD, BEGIN YEAR TO END YEAR.

IF (ICRPTB .EQ. 0) GOTO 900
