...
LOGICAL DEBUG
!----------
!  CURRENTLY THE HERB AND SHRUB VALUES ARE ESTIMATED VERY CRUDELY FROM
!  THE FOLLOWING PUBLICATION:
!
!  Chojnacky, D.C., R.A. Mickler, L.S. Heath, and C.W. Woodall.  2004.
!  Estimates of down woody material in eastern US forests.
!  Environmental Management 33(1): S44-S55.
!
!  THIS NEEDS TO BE IMPROVED ONCE THE NORTHEAST PHOTOSERIES IS RELEASED.
!----------
!                  herbs, shrubs
...
!  FROM FIA FOREST TYPE AND SIZE CLASS (based on FIA plot fuels data from the northeast)
!----------
...
!   SET COVTYP TO A DEFAULT BALSAM FIR COVER. AFTER THE
