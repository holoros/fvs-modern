...
!        I -- TREE SUBSCRIPT.
!        D -- TREE DIAMETER.
!      RIP -- ESTIMATED ANNUAL MORTALITY RATE BASED ON HAMILTONS
!             MODEL.
...
DATA PMD/ &
         ...
         0.0,      0.0,      0.0,      0.0/
!
! IN THE ARRAYS IPDG AND IPDG2, THE I INDEX REFERS TO HABITAT TYPE,
! THE J INDEX REFERS TO NATIONAL FOREST.
! NOTE: THESE ARE NI HABITAT TYPES (1-30) AND NI NATIONAL FORESTS.
!
...
!
!  THIS ARRAY MAPS THE CI FOREST TO AN EQUIVALENT NI FOREST FOR SETTING
!  THE MORTALITY CONSTANTS FROM THE IPDG AND IPDG2 ARRAYS.
!  NI NEZPERCE COEFFICIENTS ARE USED FOR CI NEZPERCE AND PAYETTE;
!  NI BITTERROOT COEFFICIENTS FOR CI BOISE, CHALLIS, SALMON AND SAWTOOTH.
!
...
29 CONTINUE
!----------
!  APPLY 60 PERCENT OF NI RATE FOR WB,PY,AS,MC,LM,CW, AND OH.
!  APPLY 20 PERCENT OF NI RATE FOR WJ
!----------
SELECT CASE (ISPC)
CASE (11:13,15:17,19)
...
!  TIME RESOLUTION.  ITYPE IS A HABITAT INDEX THAT IS COMPUTED IN
!  **HABTYP** . IFOR=10 IN THE NI/IE VARIANT IS THE NEZ PERCE
!----------
MIFOR=MAPFOR(IFOR)
