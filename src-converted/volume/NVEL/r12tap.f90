...
!       (TAPEQ-INT  DBHOB-R  HT1-R  HT2-R  D2-R)
!
!      HAWAII STEM PROFILE MODEL USES THE SHARPNECK MODEL.

!      DBHOB - SINGLE PRECISION VALUE FOR DBH
!      SVOL - SINGLE PRECISION VALUE FOR SEGMENT VOLUME
!      DBH - DOUBLE PRECISION VALUE FOR DBH
!      VOLCOR - DOUBLE PRECISION COMPUTED VOLUME
!      HT1 - SINGLE PRECISION FOR TOTAL TREE SEGMENTS
!      HT2 - SINGLE PRECISION VALUE FOR CURRENT SEGMENT NUMBER
!      HTTOT - DOUBLE PRECISION VALUE FOR HT1
!      HTUP - DOUBLE PRECISION VALUE FOR HT2
!      R5SC - SHARPNACK COFFICIENTS
!      SP - SUBSCRIPT TO USE FOR SPECIES COEFFICIENTS
!
!      SPECIES SUBSCRIPTS ARE AS FOLLOWS
!      KOA = 1
!      OHIA = 2
!      ROBUSTA EUCALYPTUS = 3
!      SALIGNA EUCALYPTUS = 4
!
!###########################################################
...
! species, coefficient number, segment number
...
!****************************************************************
!    COFFICIENTS FOR SHARPNECK MODEL(B0,B1,B2,B3,B4,B5,B6)     **
!****************************************************************
!  BOARD FOOT
!     KOA
