...
!
!  Purpose:
!     Reports a summary of snag statistics for all years that
!     coinside with a FVS cycle boundary.
!
!OMMONS
!
!
...
!
!     CALL THE DBS MODULE TO OUTPUT SUMMARY SNAG REPORT TO A DATABASE
!
DBSKODE = 1
