...
!
!  Revision History:
!    21-APR-10 Lance David (FMSC)
!       New for the Tetons variant 18 species expansion.
...
!             WB LM DF PM BS AS LP ES AF PP UJ RM BI MM NC MC OS OH   -- TT specie
DATA IBIOMP / &
            1, 4, 3,11, 8,11, 7, 8, 9,10,11,11,11,11,11,11,11,11/ !-- BIOMASS index
!             WP GF DF --  S -- LP  S AF PP -- -- -- -- -- -- -- --   -- BIOMASS specie
!
