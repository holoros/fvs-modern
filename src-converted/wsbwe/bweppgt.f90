...
!----------
!  Purpose:
!     Get (read) the GenDefol/Budworm model data for a given stand
!     from buffer.
...
!
!  Revision History :
!   08-SEP-2006 - Lance R. David (FHTET)
...
!
!     READ ALL INTEGER VARIABLES WITH IFREAD, LOGICAL VARIABLES
!     WITH LFREAD, AND REAL VARIABLES WITH BFREAD.
!     LONG INTEGERS ARE EQIVALENCED TO REAL VARIABLES AND READ
!     WITH BFREAD.
!     DOUBLE PRECISION VARIABLES (RANDOM NUMBER SEEDS) ARE EQUIVALENCED
!     TO REAL ARRAYS OF LENGTH 2 AND READ WITH BFREAD.
!
...
!     Read logical scalars from buffer.
!
...
!.... Load logical scalars from LOGICS array.
!
!---- from common BWEBOX ------------
LTEMP1(1) = LOGICS(1)
LTEMP1(2) = LOGICS(2)
...
!.... Read integer scalars from buffer.
!
...
!.... Load integer scalars from the INTS array.
!
!---- from common BWEBOX ------------
IBUDYR      = INTS(1)
IBWOPT      = INTS(2)
...
!.... Read larger integer arrays from buffer
!
...
!
!     CALL IFREAD (WK3,IPNT,ILIMIT, array, length, K)
!     .....................................................................
...
!.... Read real varaibles (scalars and arrays) from buffer.
IIX = 301
...
!.... Load real scalars then arrays from the REALS array.
...
!.... Read next real array(s) from buffer.
IIX = 192
CALL BFREAD (WK3, IPNT, ILIMIT, REALS, IIX, K)

IF (PDEBUG) WRITE (JOPPRT,*) 'IN BWEPPGT: 2 - REALS=', &
               REALS
!.... Load next real array(s) from REALS.
...
!
!.... Read double precision scalars (random number seeds) from buffer.
...
!
!.... Read character variables from buffer.
!
