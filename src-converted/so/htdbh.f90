...
!             2 IS FREMONT
!             3 IS WINEMA
!            10 IS WARM SPRINGS RESERVATION
...
! 31=MB, 32=OS, 33=OH
!
!  FREMONT COEFFS FOR OT USED FOR DESCHUTES.
!----------
...
!
!  DESCHUTES COEFFS FOR DF AND ES USED FOR FREMONT
!
...
!  WINEMA EQNS ARE USED FOR REGION 5 FORESTS.
!  DESCHUTES COEFFICIENTS ARE USED FOR WARM SPRINGS RESERVATION
!----------
SELECT CASE (IFOR)
  CASE (1,10)
    P2 = DESCHT(ISPC,1)
