...
! AK $Id$
!----------
!     PREDICTS THE PROBABILITY OF ADVANCE SPECIES.
!----------
!
!OMMONS
!
...
!  PBAPER   -- SPECIES BASAL AREA PROPORTION COEFFICIENT (B3)
...
!  SLO      -- PLOT SLOPE IN PROPORTION, PASSED IN ESCOMN.F77
...
!  PADV     -- SPECIES PROBABILITY, PASSED TO ESCOM2.F77
!----------
...
!----------
!  PREDICT PROBABILITY OF ADVANCED SPECIES
!
!  PN = B1 + B2 * XPRD + B3 * BAPER + B4 * ADJELV + B5 * ADJSLO +
!  B6 * TLAT
!
!  VARIABLES DEFINED IN SECTION ABOVE
!  PN IS CONVERTED TO PROBABILITY OF ADVANCE SPECIES BY
!  EXP(PN)/(1 + EXP(PN))
!----------
...
!           WRITE STATEMENT IS USED FOR DEBUG PURPOSES HERE. UNCOMMENT TO
!           SEE OUTPUT.
!            WRITE(16,*)' IN ESPADV',' IFT=',IFT,' ISPC=',J,' XPRD=',
!     &      XPRD,' BAPER=',BAPER,' ADJELV=',ADJELV,' ADJSLO=',ADJSLO,
!     &      ' TLAT=',TLAT,' OCCURFT=',OCURFT(J,IFT),' XESMLT=',
!     &      XESMLT(J),' PN=',PN,' PADV=',PADV(J)
