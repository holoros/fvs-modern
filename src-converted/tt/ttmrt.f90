...
! PP USES PP EQUATIONS FROM CI; HOWEVER, CI DOESN'T REDISTRIBUTE
!      MORTALITY USING A ROUTINE LIKE TTMRT. THE VARADJ VALUE FOR
!      PP IN THIS ROUTINE COMES FROM THE UT VARIANT FOR PP.
...
!
  SELECT CASE (JSPC)
!----------
!  SPECIES USING EQUATIONS FROM THE CR VARIANT (NC, OH)
!----------
  CASE(15,18)
