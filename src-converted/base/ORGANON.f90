...
!----------
!
LOGICAL   LORGANON,LORGPREP,LORGVOLS
!
INTEGER ITEST
!
INTEGER*4 BHAGE,CYCLG,IERROR,NPTS,NTREES1,NTREES2,STAGE,VERSION
!
INTEGER*4 BRCNT(2000,3),BRDIA(2000,40),BRHT(2000,40),INDS(30), &
             IORG(2000),JCORE(2000,40),NPR(2000),PRAGE(2000,3), &
             PTNO(2000),SERROR(35),SPECIES(2000),SWARNING(9), &
             TERROR(2000,6),TREENO(2000),TWARNING(2000),USER(2000)
!
REAL*4 BABT,CFSH,CFTD,CFTDHW,LOGLL,LOGML,LOGSH,LOGTA,LOGTD,MSDI_1, &
          MSDI_2,MSDI_3,OAHT,OCC,SITE_1,SITE_2
!
REAL*4 ACALIB(3,18),BART(5),CR1(2000),CR2(2000),CRCHNG(2000), &
          DBH1(2000),DBH2(2000),DGRO(2000),EXPAN1(2000),EXPAN2(2000), &
          HGRO(2000),HT1OR(2000),HT2OR(2000),MGEXP(2000), &
          MORTEXP(2000),PN(5),PRCR(2000,3),PRDBH(2000,3), &
          PREXP(2000,3),PRHT(2000,3),PRLH(2000,3),RVARS(30), &
          SCR1B(2000),SCR2B(2000),SCRCHNG(2000),STOR(30),YSF(5), &
          YST(5)
!
COMMON /ORGANON/  ACALIB,BABT,BART,BHAGE,BRCNT,BRDIA,BRHT,CFSH, &
     CFTD,CFTDHW,CR1,CR2,CRCHNG,CYCLG,DBH1,DBH2,DGRO,EXPAN1,EXPAN2, &
     HGRO,HT1OR,HT2OR,IERROR,INDS,IORG,ITEST,JCORE,LOGLL,LOGML,LOGSH, &
     LOGTA,LOGTD,LORGANON,LORGPREP,LORGVOLS,MGEXP,MORTEXP,MSDI_1, &
     MSDI_2,MSDI_3,NPR,NPTS,NTREES1,NTREES2,OAHT,OCC,PN,PRAGE,PRCR, &
     PRDBH,PREXP,PRHT,PRLH,PTNO,RVARS,SCR1B,SCR2B,SCRCHNG,SERROR, &
     SITE_1,SITE_2,SPECIES,STAGE,STOR,SWARNING,TERROR,TREENO, &
     TWARNING,USER,VERSION,YSF,YST
!
!----------
!  VARIABLE DEFINITIONS:
!----------
!  VARIABLES ORIGINALLY DECLARED BY JEFF, BUT THEY DID NOT APPEAR IN THE
!  ORGANON.F77 COMMON LIST (SO I (GED) TOOK THEM OUT)
!        INTEGER*4
!       4          NXT,BNXT,
...
!  CFSH            R * 4                        CUBIC FOOT STUMP HEIGHT
!  CFTD            R * 4                        CUBIC FOOT TOP DIAMETER
!  CFTDHW          R * 4                        CUBIC FOOT TOP DIAMETER FOR HARDWOODS
...
!  LOGSH           R * 4                        BF STUMP HEIGHT, IN FEET
!  LOGTA           R * 4                        LOG TRIM, IN INCHES
!  LOGTD           R * 4                        BF TOP DIAMETER, IN INCHES
...
!  LORGVOLS        L                            .TRUE. WHEN USING ORGANON VOLUME ROUTINES
...
!  OAHT            R * 4                        ORGANON AVERAGE HT
!  OCC             R * 4                        ORGANON PERCENT CANOPY COVER
