...
!
! EQUATIONS AND COEFFICIENTS FOR THIS SUBROUTINE COME FROM 'SITE INDEX
! CONVERSION EQUATIONS FOR THE NORTHEAST' BY DON HILT.  FILE REPORT
! NUMBER 1: RESEARCH WORK UNIT FS-NE-4153.
!----------
!
!OMMONS
!
...
!OMMONS
!
REAL SICOEF(28,28),SDICON(MAXSP)
...
!----------
DATA SDICON / &
     655., 387., 412., 506., 412., 500., 412., 505., 529., 480., &
...
!----------
!  LOAD SITE INDEX CONVERSION COEFFICIENTS
!----------
...
!----------
!  IF SITE INDEX SPECIES IS NOT GIVEN, THEN ASSUME AN AVERAGE SITE
!  INDEX OF 56 FOR SUGAR MAPLE.
!----------
...
HT2(108)=-5.1435
!----------
!  FOR ALLEGHENY SUBSTITUTE HT-DBH COEFFICIENTS FIT FROM TECH NOTE 6
!  BY A.F.HOUGH
!----------
IF(IFOR.EQ.3)THEN
! RED MAPLE
...
! YELLOW BIRCH
  HT1(30) = 4.4635
  HT2(30) = -3.6456
! SWEET BIRCH USE YELLOW BIRCH
  HT1(31) = 4.4635
  HT2(31) = -3.6456
! PAPER BIRCH USE YELLOW BIRCH
  HT1(33) = 4.4635
  HT2(33) = -3.6456
! AMERICAN BEECH
  HT1(40) = 4.5497
  HT2(40) = -4.6727
! ASH SP. USE WHITE ASH
  HT1(41) = 4.6804
  HT2(41) = -4.5561
! WHITE ASH
  HT1(42) = 4.6804
  HT2(42) = -4.5561
! GREEN ASH USE WHITE ASH
  HT1(44) = 4.6804
  HT2(44) = -4.5561
! BLACK CHERRY
  HT1(54) = 4.7614
...
! BLACK OAK
  HT1(69) = 4.9100
  HT2(69) = -7.2941
! OTHER HARDWOODS USE HOPHORNBEAM
  HT1(71) = 4.4393
  HT2(71) = -4.0711
! AMERICAN BASSWOOD
  HT1(93) = 4.6855
  HT2(93) = -4.8690
! SERVICEBERRY USE HOPHORNBEAM
  HT1(102) = 4.4393
  HT2(102) = -4.0711
! HOPHORNBEAM
  HT1(106) = 4.4393
  HT2(106) = -4.0711
! PIN CHERRY  USE BLACK CHERRY
  HT1(108) = 4.7614
  HT2(108) = -5.3776
ENDIF
!----------
!  SET SDIDEF ARRAY, IF NOT SET BY KEYWORD.
!----------
DO 30 I=1,MAXSP
