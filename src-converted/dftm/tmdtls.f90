...
! DFTM $Id$
!----------
!     **** This listing of revision dates has NEVER been maintained ****
!
!     TMDTLS WRITES A LISTING OF THE DATE OF THE LAST REVISION
!     FOR EACH SUBROUTINE.  IF YOU CHANGE A SUBROUTINE YOU MUST
!     UPDATE THIS LISTING AND THE COMMENT IN LINE 3 OF THE ROUTINE.
!     FAILURE TO DO SO WILL CAUSE VIOLENT REACTIONS RESULTING
