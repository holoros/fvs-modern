...
!
!     HT OF TALLEST SUBSEQUENT WWP. 6JAN88 CARLSON
!
10 CONTINUE
...
GO TO 300
!
!     HEIGHT OF TALLEST SUBSEQUENT WESTERN LARCH. 7JAN88 CARLSON
!
20 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT D-FIR. 8JAN88 CARLSON
!
30 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT GRAND FIR. 6JAN88 CARLSON
!
40 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT W. HEMLOCK. 7JAN88 CARLSON
!
50 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT W.CEDAR.
!
60 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT LPP. 7JAN88 CARLSON
!
70 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT E. SPRUCE. 7JAN88 CARLSON
!
80 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT SAF.  6JAN88 CARLSON
!
90 CONTINUE
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT M. HEMLOCK (USES WH EQUATION).
!
110 CONTINUE
PN= -2.42379 +1.52366*AGELN -0.003256*BAA
HHT = EXP(PN +EMSQR*DILATE*BNORM*0.54116)
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT WHITEBARK PINE (USES WL)
!
120 CONTINUE
PN= -1.36257 +1.21548*AGELN -0.003797*BAA +UHAB(IHTSER,2) &
       +UPRE(IPREP,2)
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT LIMBER PINE
!
130 CONTINUE
PN = 0.0
HHT = 0.5
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT SUBALPINE LARCH (USES SAF)
!
140 CONTINUE
PN= -2.06377 +1.18184*AGELN -0.0044465*BAA +0.06615*XCOS &
       +0.03085*XSIN -0.37402*SLO
...
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT PINYON
!
150 CONTINUE
PN = 0.0
HHT = 0.5
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT JUNIPER
!
160 CONTINUE
PN = 0.0
HHT = 0.5
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT PACIFIC YEW
!
170 CONTINUE
PN = 0.0
HHT = 0.5
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT ASPEN
!
180 CONTINUE
PN = 0.0
HHT = 5.0
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT COTTONWOOD
!
190 CONTINUE
PN = 0.0
HHT = 5.0
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT MOUNTAIN MAPLE
!
200 CONTINUE
PN = 0.0
HHT = 5.0
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT PAPER BIRCH
!
210 CONTINUE
PN = 0.0
HHT = 5.0
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT OTHER HARDWOOD
!
220 CONTINUE
PN = 0.0
HHT = 5.0
GO TO 300
!
!     HT OF TALLEST SUBSEQUENT OTHER SOFTWOOD (USES MH)
!
230 CONTINUE
PN= -2.42379 +1.52366*AGELN -0.003256*BAA
HHT = EXP(PN +EMSQR*DILATE*BNORM*0.54116)
