...
!     AN INTEGER INDEX TO THE SPECIES. NORMAL VALUES ARE IN THE 1-15
!     RANGE; NON-MATCHES ARE ASSIGNED 14. THIS MESSY FORM IS SIMPLEST
!     GIVEN THE WIDE VARIETY OF INPUT SPECIES CODES.
!
INCLUDE 'PRGPRM.f90'
!
!
