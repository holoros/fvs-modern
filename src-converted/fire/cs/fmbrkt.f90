...
!----------
!  THE BARK THICKNESS FOR SHORTLEAF PINE IS FROM HARMON,
!  SURVIVAL OF TREES AFTER LOW-INTENSITY SURFACE FIRES IN GREAT SMOKY
!  MOUNTAINS NATIONAL PARK, ECOLOGY 65(3), 1984.
!  THIS WAS CHANGED BECAUSE USERS ON THE OZARK NF THOUGHT THE FIRE-
!  RELATED MORTALITY FOR SHORTLEAF WAS TOO HIGH.
!----------
IF (ISP .EQ. 3) THEN
