...
!----------
!
!     PROB OF ADVANCED WHITEBARK PINE (USE NI WP)
!
...
PADV(1)=(1.0/(1.0+EXP(-PN)))*OCURHT(IHAB,1)*XESMLT(1) &
      *OCURNF(IFO,1)
!
!     PROB OF ADVANCED WESTERN LARCH (USE NI WL)
!
20 CONTINUE
...
PADV(2)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,2)  *XESMLT(2) &
      *OCURNF(IFO,2)
!
!     PROB OF ADVANCED DOUGLAS-FIR (USE NI DF)
!
21 CONTINUE
...
PADV(3)=(1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,3)   *XESMLT(3) &
      *OCURNF(IFO,3)
!
!     PROB OF ADVANCED LIMBER PINE (USE IE LM)
!
PADV(4)=0.
!
!     PROB OF ADVANCED SUBALPINE LARCH (USE IE AF)
!
...
PADV(5)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,5)  *XESMLT(5) &
      *OCURNF(IFO,5)
!
!     PROB OF ADVANCED ROCKY MTN JUNIPER (USE IE JU)
!
22 CONTINUE
PADV(6)=0.
!
!     PROB OF ADVANCED LODGEPOLE PINE (USE NI LP)
!
...
PADV(7)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,7)  *XESMLT(7) &
      *OCURNF(IFO,7)
!
!     PROB OF ADVANCED ENGELMANN SPRUCE (USE NI ES)
!
28 CONTINUE
...
PADV(8)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,8)  *XESMLT(8) &
      *OCURNF(IFO,8)
!
!     PROB OF ADVANCED SUBALPINE FIR (USE NI AF)
!
...
PADV(9)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,9)  *XESMLT(9) &
      *OCURNF(IFO,9)
!
!     PROB OF ADVANCED PONDEROSA PINE (USE NI PP)
!
32 CONTINUE
...
PADV(10)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,10)*XESMLT(10) &
      *OCURNF(IFO,10)
!
!     PROB OF ADVANCED FOR ANY OTHER SPECIES
!
34 CONTINUE
PADV(11)=0.0
PADV(12)=0.0
