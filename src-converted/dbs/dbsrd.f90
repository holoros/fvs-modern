...
!     This variable is used for ColNumber set and increment
!     to eliminate the number translation warning being reported
!     when compiling with gfortran. LD 01/15/2015
I1 = 1
...
!     CHECK TO SEE IF THE RD SUMMARY TABLE EXISTS IN THE DATBASE
!      WRITE(23,*) "IN DBSRD1: DBMSOUT = ",DBMSOUT                ! DEBUG
...
!      WRITE(23,*) "IN DBSRD1: DBSKNROWS IRCODE = ",IRCODE        ! DEBUG
!      WRITE(23,*) "IN DBSRD1: CASEID = ",CASEID                  ! DEBUG
