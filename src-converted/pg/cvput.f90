...
!----------
!
!     STORE THE COVER DATA FOR A GIVEN STAND.
!
...
REAL REALS (MXR)
!
!     SET THE VALUE OF IP1, WHICH WILL CONTROL HOW MANY WORDS
!     GET WRITTEN DEPENDING ON WHAT CYCLE WE ARE IN.
!
IP1=ICYC+1
!
...
!
!     PUT THE ONE DIMENSIONAL ARRAYS.
!
