...
REAL HEIGHT(99),ESPROB(99),WTAVEHT
...
5 CONTINUE
!
!     IF NOT THE FIRST TALLY, CANCEL MECH & BURNPREP IN THIS CYCLE.
!
IF(NTALLY.GT.1) THEN
...
ENDIF
!
!     INITIALIZE PRMS ARRAY TO ZERO'S
!
DO I = 1,6
  PRMS(I) = 0.0
ENDDO
...
!
!     PROBABILITY OF STOCKING CODE USED TO BE HERE.
!
137 CONTINUE
!
...
!
!     PICKING BEST TREES USED TO BE DONE HERE.
!
...
6016 FORMAT(/,T6,'SUMMARY OF ALL',T30,'SUMMARY OF BEST         ', &
     'TREES <',F4.1,' CM DBH',/,T6,'TREES REGENERATING',T30, &
...
6014 FORMAT(T9,A2,2X,2F6.0,4X,2F6.0,1X,F5.1,6X,2F6.0,3X,A2)
 ...
 CALL DBSTALLY(SUMPRB,NTALLY,NSP(I,1), &
      TOTTPA(I)  / ACRtoHA, &
      TOTPCT(I), &
      BESTPA(I)  / ACRtoHA, &
      BESPCT(I), &
...
222 CONTINUE
 ...
 CALL DBSTALLY(SUMPRB,NTALLY,FINAL, &
      TOTTPA(1)  / ACRtoHA, &
      TOTPCT(1), &
      BESTPA(1)  / ACRtoHA, &
      BESPCT(1), &
