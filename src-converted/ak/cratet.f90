...
CHARACTER*4 UNDER
!
INTEGER I,I1,I2,I3,II,IM,IPTR,IS,ISPC,J,JJ
INTEGER K1,K2,K3,K4,NH
!
INTEGER KNT(MAXSP),KNT2(MAXSP)
!
REAL AX,BX,D,H,HS,Q,SUMX
REAL XN,XX,YY,AX1,BX1,CX1
!
REAL SPCNT(MAXSP,3),XMAX
!
!----------
!  SPECIES ORDER:
...
!  TO DO SO. IWHO, PARAMETER 1, HAS NO AFFECT ON XMAXPT ARRAY VALUES.
!
CALL SDICAL (0, XMAX)
!---------
...
!  DUB HEIGHTS WITH DEFAULT COEFFICIENTS FOR THIS SPECIES.
!----------
KNT(IPTR)=K3
IF(K1 .LT. 3 .OR. .NOT. LHTDRG(ISPC)) GO TO 110
XN=REAL(K1)
AA(ISPC) = SUMX / XN
!----------
! IF THE INTERCEPT IS NEGATIVE, USE THE DEFAULT COEFFICIENTS.
!----------
...
! ADJUST HEIGHT IMPUTATION BASED ON SPECIES
...
140 CONTINUE
IF(DEBUG)THEN
  WRITE(JOSTND,9005) ISPC,K2,AX,BX
...
!  AK VARIANT DOES NOT ESTIMATE TREE AGE. IF AGE IS PROVIDED ON INPUT
!  TREE RECORD, IT WILL BE INCREMENTED. PLANTED AND REGEN TREES DO NOT
!  GET AGE ASSIGNMENTS EITHER.
!----------
IF(DEBUG)WRITE(JOSTND,*)'IN CRATET, SET TREE AGE 0 IF LT 0'
DO I=1,ITRN
IF(ABIRTH(I) .LT. 0.)THEN
  ABIRTH(I)=0.0
ENDIF
ENDDO
!----------
...
CALL DENSE
!----------
! COUNT AND PRINT NUMBER RECORDS WITH MISTLETOE
!----------
CALL MISCNT(KNT)
