...
! NI $Id$
!----------
!  CALLED FROM INTREE, WHEN THE INPUT SPECIES CODE IS NOT RECOGNIZED.
!  THIS ROUTINE ASSIGNS THE MOST SIMILAR SPECIES SEQUENCE NUMBER TO THE
!  SPECIES NOT RECOGNIZED IN THE VARIANT.  TRANSLATES FVS ALPHA CODES,
!  FIA CODES, AND USDA PLANTS SYMBOLS.  THE ASPT ARRAY CONTAINS THE
!  SPECIES MAPPING.  ALL SPECIES MAPPING WAS APPROVED BY THE FVS
!  REGIONAL CONTACTS IN APRIL 2007. TO PROVIDE ADEQUATE CODE
...
SPCOUT= 'XX '
!----------
!  TRANSLATE INCOMING SPECIES, SPCIN, TO VARIANT SPECIFIC RECOGNIZED
!  SPECIES, SPCOUT.
!----------
DO 100 I= 1,MAXASPT
...
150 CONTINUE
!----------
!  FIND STANDARD SPECIES NUMBER FOR VARIANT TO RETURN TO INTREE.
!  IF SPECIES CODE WAS NOT SET, RETURN MAXIMUM SPECIES NUMBER.
!----------
ISPC1= 0
...
JSPIN(ISPC1)=IJSPIN
!----------
!  IN THE EVENT THAT EXECUTABLE IS THE OLD 11 SPECIES SORNEC VARIANT
!  SET ISPC1 EQUAL TO MAXSP
!----------
