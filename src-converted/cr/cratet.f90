...
!
! SPECIAL BLACK HILLS MODIFICATION TO HEIGHT DUBBING LOGIC.
! BH DEFAULT EQUATION FOR ALL SPECIES, USE CALIBRATED LOGISTIC EQUATION
! IF ENOUGH OBSERVATIONS EXISTED TO CALIBRATE IT
!
