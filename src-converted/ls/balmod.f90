...
!
!----------
!  VALUES FOR CHECKING D/RMSQD IN EXPRESSION FOR OMEGA
!----------
DATA CHECK/ &
...
!----------
!  COEFFICIENTS FOR OMEGA PORTION OF THE MODIFIER EQUATION
!----------
DATA B1/ &
...
!----------
!  COEFFICIENTS FOR THE BETA PORTION OF THE MODIFIER EQUATION.
!----------
DATA C1/ &
...
!----------
!  COEFFICIENTS FOR MAXIMUM BASAL AREA.
!  (IF THESE CHANGE, ALSO CHANGE THEM IN **SITSET**)
!----------
DATA BAMAX1/ &
...
GM=1.
!----------
!  COMPUTE OMEGA PORTION OF THE MODIFIER
!----------
...
ELSE
!        ----------
!        Computation of the value used in the EXP function was
!        seperated from OMEGA calculation so that underflow of single
!        precision variable is avoided.                 LD 2/27/19
!                                     |--------------|
...
!----------
!  COMPUTE BETA PORTION OF THE MODIFIER
!----------
...
!----------
!  COMPLETE THE COMPUTATION OF THE MODIFIER
!----------
