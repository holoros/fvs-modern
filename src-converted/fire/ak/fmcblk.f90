...
!     GROUPING FOR THE JENKINS BIOMASS EQUATIONS FOR C REPORTING
!     SOFTWOODS
!       1=CEDAR/LARCH
!       2=DOUGLAS-FIR
!       3=TRUE FIR/HEMLOCK
...
!      10=WOODLAND JUNIPER/OAK/MESQUITE
...
! DATA Statement Debug Information
!         Variant   = AK (taken from PN)
!        Interval   = 1 yrs
!      Field tags   = PWW;sw;pulp
! SubRegion index I = 1
!  DataType index K = 1 (1=InUse; 2=Landfill; 3=Energy)
!  Pulp/Saw index M = 1 (1=Pulp;  2=Saw)
!     Sw/Hw index N = 1 (1=Soft;  2=Hard)
...
!      Field tags   = PWW;sw;pulp
! SubRegion index I = 1
!  DataType index K = 2 (1=InUse; 2=Landfill; 3=Energy)
!  Pulp/Saw index M = 1 (1=Pulp;  2=Saw)
!     Sw/Hw index N = 1 (1=Soft;  2=Hard)
...
!      Field tags   = PWW;sw;pulp
! SubRegion index I = 1
!  DataType index K = 3 (1=InUse; 2=Landfill; 3=Energy)
!  Pulp/Saw index M = 1 (1=Pulp;  2=Saw)
!     Sw/Hw index N = 1 (1=Soft;  2=Hard)
...
!         Variant   = AK (taken from PN)
!        Interval   = 1 yrs
!      Field tags   = PWW;sw;saw
! SubRegion index I = 1
!  DataType index K = 1 (1=InUse; 2=Landfill; 3=Energy)
!  Pulp/Saw index M = 2 (1=Pulp;  2=Saw)
!     Sw/Hw index N = 1 (1=Soft;  2=Hard)
...
!         Variant   = AK (taken from PN)
!        Interval   = 1 yrs
!      Field tags   = PWW;hw;all
! SubRegion index I = 1
!  DataType index K = 1 (1=InUse; 2=Landfill; 3=Energy)
!  Pulp/Saw index M = 1 (1=Pulp;  2=Saw)
!     Sw/Hw index N = 2 (1=Soft;  2=Hard)
