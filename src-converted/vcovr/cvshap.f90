...
! VCOVR $Id$
!----------
!  SUBROUTINE CVSHAP ASSIGNS EACH TREE CROWN TO ONE OF FIVE SHAPES.
!  SHAPES ARE:
...
!     MOEUR, M.  MODELS FOR PREDICTING CROWN SHAPES OF NORTHERN ROCKY
!        MOUNTAIN CONIFERS.  REPORT ON FILE, NOVEMBER 1983.
!
! 1-11 REFERRING TO ORIGINAL 11 NI SPECIES:
!  CONST(5,11), BCL(5,11), BCR(5,11), BRAD(5,11),
!  BDBH(5,11), BHT(5,11), BTPA(5,11) -- COEFFICIENTS
!  CL      -- CROWN LENGTH
!  CR      -- CROWN RATIO
!  ISHAPE(MAXTRE) -- PREDICTED CROWN SHAPE
!  RAD     -- CROWN RADIUS
!  TPA     -- TREES PER ACRE
!  SCORE(5) -- DISCRIMINANT FUNCTION SCORE
!----------
!OMMONS
!
!
