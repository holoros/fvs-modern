...
! BASE $Id$
!----------
!  THIS SUBROUTINE PROVIDES A TABLE LOOKUP FOR SCRIBNER SCALING
!  FACTORS FOR ALL LOGS IN TREE.  GIVEN A SMALL END DIAMETER FOR THE
!  LOG A SCALING FACTOR IS FOUND, WHICH CAN BE MULTIPLIED BY THE LOG
!  LENGTH RESULTING IN THE SCRIBNER VOLUME FOR THAT LOG.  FOR
!  LOGS BETWEEN 6" AND 11" IN DIAMETER THE LOG LENGTH ALSO BECOMES A
!  FUNCTION IN THE TABLE LOOKUP.
!
!  VARIABLES:
! NAME   SOURCE TYPE             DESCRIPTION
! ------ ------ ------ -------------------------------------------------
! FACTB   LOCAL R(120) CONTAINING MOST OF THE SCALING FACTORS.
! FACTB1  LOCAL R(6)   CONTAINING FACTORS OF 6"-11" AND 1'-15' LOGS.
! FACTB2  LOCAL R(6)   CONTAINING FACTORS OF 6"-11" AND 16'-31' LOGS.
! FACTB3  LOCAL R(6)   CONTAINING FACTORS OF 6"-11" AND 32'-40' LOGS.
! FACTOR  ARGMT R(19)  RETURNS THE SCALING FACTORS FROM THE TABLE LOOKUP
! GLOGLN  ARGMT R(19)  LOG LENGTH FOR TABLE LOOKUP.
! NUMLOG  ARGMT INTGR  NUMBER OF LOGS IN TREE.
! SMDIA   ARGMT I(19)  SMALL END DIAMETER OF THE LOG.
!
!----------
INTEGER JOSTND,ISMD
...
!----------
!  COMPUTE FACTOR INDEX, IF LESS THAN 1 SET EQUAL TO 1 TO PICK UP
!  A FACTOR OF 0.
!----------
ISMD = NINT(SMD)
IF(ISMD .LT. 1) ISMD=1
