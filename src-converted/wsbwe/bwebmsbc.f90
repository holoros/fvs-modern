...
!
!**** IBIOMP IS SET FOR THE FOLLOWING VARIENTS
!     NI Was:       WP  WL  DF  GF  WH  RC  LP  ES  AF  PP  OT
!     CI Was:       WP  WL  DF  GF  WH  RC  LP  ES  AF  PP  OT
!     EM Was:       WB  WL  DF  GF  WH  RC  LP  ES  AF  PP  OT
!     TT Was:       WB  LM  DF  --  --  RC  LP  ES  AF  --  OT

!     IB            PW  LW  FD  BG  HW  CW  PL  SE  BL  PY
