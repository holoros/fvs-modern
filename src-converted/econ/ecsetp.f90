...
! Initialize ECON start if necessary and creates sorted indexes for accumulating harvest revenues from keywords.

! Called from MAIN in cycle=0, once for each simulated stand after reading all keywords.
