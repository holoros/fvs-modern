...
!----------
!  Purpose:
!     Put (write) the Fire Model data for a given stand to DA file.
!
!----------------------------------------------------------------------
!
...
!     Parameter and other include files that are not stored here

INCLUDE 'PRGPRM.f90'
INCLUDE 'CONTRL.f90'
INCLUDE 'SVDATA.f90'

!     Include files that are stored here
...
INTS( 62) = NSNAGSALV
INTS( 63) = NYRS
!------- Carbon reporting INTEGER variables --------
INTS( 64) = ICHABT
INTS( 65) = ICHPAS
INTS( 66) = ICHRVB
INTS( 67) = ICHRVE
...
INTS( 73) = IDCHRV
INTS( 74) = IDCRPT
!------- new FFE INTEGER variables --------
INTS( 75) = IFLOGIC
INTS( 76) = IFMSET
INTS( 77) = ICYCRM
INTS( 78) = ITRNL
!------- new FFE INTEGER variables for down wood reports --------
INTS( 79) = IDWPAS
INTS( 80) = IDWRPB
INTS( 81) = IDWRPE
INTS( 82) = IDCPAS
...
REALS ( 44) = CANMHT
REALS ( 45) = CBHCUT
!------- Carbon reporting REAL variables --------
REALS ( 46) = CRDCAY
REALS ( 47) = BIOLIVE
REALS ( 48) = BIOSNAG
REALS ( 49) = BIODDW
