...
LOGICAL DEBUG
INTEGER ISPC,JOSTND
REAL SM45,X2,X3,TERM,B,TERM2,B50,X1,Z,AZ,BZ
...
CASE(1)
  SM45 = SINDX-4.5
  HGUESS = (1.0 - EXP(-(0.0071839 + 0.0000571 * SM45 ) * AG))** &
              1.39005 / (1.0 - EXP(-(0.0071839 + 0.0000571 * SM45 ) &
              * 100.))**1.39005
...
! SPECIES: YC, RW, BM, WA, PB, GC, AS, CW, WJ, WB, KP, PY, DG, HT, CH, WI, OT
!----------
CASE(8,17,21,23:27,29,31:37,39)
...
CASE(16,28)
  ...
  IF(DEBUG)WRITE(JOSTND,*)' HTCALC DF/WO Z,HGUESS= ',Z,HGUESS
!----------
...
!----------
CASE(6,18)
  AZ = -0.2050542 + 1.449615*ALOG(AG) - 0.01780992*ALOG(AG)**3. + &
           6.519748E-5*ALOG(AG)**5. - 1.095593E-23*ALOG(AG)**30.
  BZ = -5.611879 + 2.418604*ALOG(AG) - 0.2593110*ALOG(AG)**2. + &
           1.351445E-4*ALOG(AG)**5.- 1.701139E-12*ALOG(AG)**16. + &
           7.964197E-27*ALOG(AG)**36.
  HGUESS = 4.5 + EXP(AZ) - 86.43*EXP(BZ) + (SINDX-4.5)*EXP(BZ)
  IF(DEBUG)WRITE(JOSTND,*)' HTCALC SS/RC AZ,BZ,HGUESS= ', &
     AZ,BZ,HGUESS
!----------
! BLANK SPECIES ISPC = 38
! FUTURE SPECIES
!----------
CASE DEFAULT
  HGUESS = 0.
