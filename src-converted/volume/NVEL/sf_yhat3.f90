...
!      given 1 or 2 upper extra measurements, compute the new
!        conditional expectation.
!
!     H     input    R*4  section height of interest
!     DIB   input    R*4  original estimate of diameter inside bark
!     EDIB  output   R*4  conditional expectation of dib
  ...
  if (dib.le. 0.0 .or. H .ge. tht) then
       ...
       Return
  ENDIF
!                              apply formulas for 1 or 2 extra points
  if (NEXTRA.eq.1) then
