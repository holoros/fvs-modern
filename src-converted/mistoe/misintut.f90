...
!    -- -- ---------------------  ---------------------
!     1 WB WHITEBARK PINE         PINUS ALBICAULIS
!     2 LM LIMBER PINE            PINUS FLEXILIS
!     3 DF DOUGLAS-FIR            PSEUDOTSUGA MENZIESII
!     4 WF WHITE FIR              ABIES CONCOLOR
!     5 BS BLUE SPRUCE            PICEA PUNGENS
!     6 AS QUAKING ASPEN          POPULUS TREMULOIDES
!     7 LP LODGEPOLE PINE         PINUS CONTORTA
!     8 ES ENGLEMANN SPRUCE       PICEA ENGELMANNII
!     9 AF SUBALPINE FIR          ABIES LASIOCARPA
!    10 PP PONDEROSA PINE         PINUS PONDEROSA
!    11 PI COMMON PINYON          PINUS EDULIS
!    12 WJ WESTERN JUNIPER        JUNIPERUS OCCIDENTALIS
!    13 GO GAMBEL OAK             QUERCUS GAMBELII
!    14 PM SINGLELEAF PINYON      PINUS MONOPHYLLA
!    15 RM ROCKY MOUNTAIN JUNIPER JUNIPERUS SCOPULORUM
!    16 UJ UTAH JUNIPER           JUNIPERUS OSTEOSPERMA
!    17 GB BRISTLECONE PINE       PINUS LONGAEVA
!          (Great Basin)
!    18 NC NARROWLEAF COTTONWOOD  POPULUS ANGUSTIFOLIA
!    19 FC FREMONT COTTONWOOD     POPULUS FREMONTII
!    20 MC CURLLEAF MOUNTAIN-     CERCOCARPUS LEDIFOLIUS
!          MAHOGANY
!    21 BI BIGTOOTH MAPLE         ACER GRANDIDENTATUM
!    22 BE BOX ELDER              ACER NEGUNDO
!    23 OS OTHER SOFTWOODS
!    24 OH OTHER HARDWOODS
!
