...
!     SUBROUTINES to determine the default Form Class.
...
!----------
!  **FORMCL--BM     DATE OF LAST REVISION:  08/13/96
!----------
...
!----------
!  FOREST ORDER: (IFOR)
!  4=MALHEUR(604)          7=OCHOCO(607)        14=UMATILLA(614)
! 16=WALLOWA-WHITMAN(616)
!
!  SPECIES ORDER: (ISPC)
!  1=WP  2=WL  3=DF  4=GF  5=MH  6=    7=LP  8=ES  9=AF 10=PP 11=J/OT
...
!----------
!  **FORMCL--CA     DATE OF LAST REVISION:  08/27/99
!----------
...
!----------
!  FOREST ORDER: (IFOR)
!  10=ROGUE RIVER(610)      11=SISKIYOU(611)
!
!
!  SPECIES ORDER:
...
!----------
!  **FORMCL--EC     DATE OF LAST REVISION:  08/13/96
!----------
  CHARACTER*3 FIAJSP(11),SPEC
  REAL D
...
!  FOREST ORDER: (IFOR)
!  8=OKANOGAN(608)
!  17=WENATCHEE(617)        5=OKANOGAN (TONASKET RD) (699)
!
!  SPECIES ORDER: (ISPC)
!  1=WP  2=WL  3=DF  4=SF  5=RC  6=GF  7=LP  8=ES  9=AF 10=PP 11=MH/OT
...
!----------
!  **FORMCL--NI     DATE OF LAST REVISION:  08/13/96
!----------
  CHARACTER*3 FIAJSP(11),SPEC
  REAL D
...
!----------
!  **FORMCL--PN     DATE OF LAST REVISION:  09/10/99
!----------
...
!----------
!  FOREST ORDER: (IFOR)
!  1=OLYMPIC(609)  2=SIUSLAW(612)  3=QUINAULT(800)  4=BLM SALAM (708)
!  5=BLM EUGENE (709)  6=BLM COOS BAY (712)
!
!  SPECIES ORDER: (ISPC)
!  1=SF  2=WF  3=GF  4=AF  5=RF  6=    7=NF  8=YC  9=IC 10=ES
! 11=LP 12=JP 13=SP 14=WP 15=PP 16=DF 17=RW 18=RC 19=WH 20=MH
! 21=BM 22=RA 23=WA 24=PB 25=GC 26=AS 27=CW 28=WO 29=J  30=LL
! 31=WB 32=KP 33=PY 34=DG 35=HT 36=CH 37=WI 38=   39=OT
...
!----------
!  OLYMPIC FORM CLASS VALUES  (ALSO USE FOR QUINAULT)
!----------
  DATA OLYMFC/ &
...
!----------
!  **FORMCL--SO     DATE OF LAST REVISION:  08/13/96
!----------
  CHARACTER*3 FIAJSP(11),SPEC
  REAL D
...
!----------
!  FOREST ORDER: (IFOR)
!  1=DESCHUTES(601)  2=FREMONT(602)  3=WINEMA(620)
!
!  SPECIES ORDER: (ISPC)
!  1=WP  2=SP  3=DF  4=WF  5=MH  6=IC  7=LP  8=ES  9=RF 10=PP 11=J/OT
  DATA FIAJSP /'015','020','081','093','108','117','119','122', &
               '202','264','999'/

!----------
!  DESCHUTES FORM CLASS VALUES
!----------
  DATA DESHFC/ &
...
!----------
!  **FORMCL--WC     DATE OF LAST REVISION:  09/10/99
!----------
  CHARACTER*3 FIAJSP(39),SPEC
  REAL D
...
!----------
!  FOREST ORDER: (IFOR)
!  1=GIFFORD PINCHOT(603)  2=MT BAKER/SNOQ(605)  3=MT HOOD(606)
!  5=UMPQUA(615)         6=WILLAMETTE(618)
!  9=BLM ROSEBURG(710)
! 10=BLM MEDFORD/LAKEVIEW(711)
!
!  FOR VALUES NOT SUPPLIED BY BLM, USE THE FOLLOWING FOREST
!  FORM CLASS VALUES FOR THE MIDDLE (21.0"-30.9") DBH RANGE:
!  SALEM --- MT HOOD     EUGENE --- WILLAMETTE
!  ROSEBURG --- UMPQUA   MEDFORD/LAKEVIEW --- ROGUE RIVER
!
!  SPECIES ORDER: (ISPC)
!  1=SF  2=WF  3=GF  4=AF  5=RF  6=    7=NF  8=YC  9=IC 10=ES
! 11=LP 12=JP 13=SP 14=WP 15=PP 16=DF 17=RW 18=RC 19=WH 20=MH
...
!
    ...
    75, 74, 74, 70, 75, 74/
!----------
!  MOUNT BAKER / SNOQUALMIE FORM CLASS VALUES
!----------
  DATA MBSNFC/ &
