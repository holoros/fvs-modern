...
!
!  ADDED IBSERV, DEFINED FOR TT AND UT VARIANTS
!  MAPSITE -- SITE INDEX ASSIGNED BY SPECIES IS DEPENDENT UPON HABITAT TYPE
!----------
LOGICAL DEBUG
...
REAL DIAGR,DDS,CR,ASPDG,BAL,XSITE,TMPASP
