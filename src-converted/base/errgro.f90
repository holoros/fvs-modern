...
!----------
!
!     ERROR PROCESSOR FOR THE FOREST VEGETATION SIMULATOR.
!
!OMMONS
!
!
...
!!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE :: FVSGETICCODE  ! suppressed for Linux ld
!!DEC$ ATTRIBUTES ALIAS : 'FVSGETICCODE' :: FVSGETICCODE  ! suppressed for Linux ld
...
!                        ERROR NUMBER 42
5200 CONTINUE
WRITE(JOSTND,5210)  PREF
WRITE(CMSG,  5211)
5210 FORMAT(/A11,'FVS42 WARNING: IMPROPER FIELD INPUT IDENTIFIED. ', &
       'DEFAULT VALUE FOR FIELD WILL BE USED')
5211 FORMAT('FVS42 WARNING: IMPROPER FIELD INPUT IDENTIFIED. ', &
       'DEFAULT VALUE FOR FIELD WILL BE USED')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000
...
!                        ERROR NUMBER 43
5300 CONTINUE
WRITE(JOSTND,5310)  PREF
WRITE(CMSG,  5311)

5310 FORMAT(/A11,'FVS43 WARNING: FIAVBC REQUESTED ', &
       'BUT ECODIVISION CODE NOT RECOGNIZED OR MISSING. ', &
       'USING "0000" BY DEFAULT')
5311 FORMAT('FVS43 WARNING: FIAVBC REQUESTED ', &
       'BUT ECODIVISION CODE NOT RECOGNIZED OR MISSING. ', &
       'USING "0000" BY DEFAULT')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000
...
!                        ERROR NUMBER 44
5400 CONTINUE
WRITE(JOSTND,5410)  PREF
WRITE(CMSG,  5411)

5410 FORMAT(/A11,'FVS44 WARNING: STATE CODE MISSING FROM INPUT.  ', &
       'DEFAULT WOODLAND VOLUME EQUATIONS WILL BE USED FOR FIAVBC.')
5411 FORMAT('FVS44 WARNING: STATE CODE MISSING FROM INPUT.  ', &
       'DEFAULT WOODLAND VOLUME EQUATIONS WILL BE USED  FOR FIAVBC.')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000
...
!                        ERROR NUMBER 45
5500 CONTINUE
WRITE(JOSTND,5510)  PREF
WRITE(CMSG,  5511)

5510 FORMAT(/A11,'FVS45 WARNING: BFVOLEQU KEYWORD NO LONGER ACTIVE')
5511 FORMAT('FVS45 WARNING: BFVOLEQU KEYWORD NO LONGER ACTIVE')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000

!                        ERROR NUMBER 46
5600 CONTINUE
WRITE(JOSTND,5610)  PREF
WRITE(CMSG,  5611)

5610 FORMAT(/A11,'FVS46 WARNING: CFVOLEQU KEYWORD NO LONGER ACTIVE')
5611 FORMAT('FVS46 WARNING: CFVOLEQU KEYWORD NO LONGER ACTIVE')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000

!                        ERROR NUMBER 47
5700 CONTINUE
WRITE(JOSTND,5710)  PREF
WRITE(CMSG,  5711)

5710 FORMAT(/A11,'FVS47 WARNING: A DEPRECATED BOARD-FOOT VOLUME ', &
       'COMPUTATION METHOD HAS BEEN REQUESTED.  ',/T12, &
       'METHOD CODE 6 (NATIONAL VOLUME ESTIMATOR LIBRARY) WILL BE ', &
       'USED BY DEFAULT.' )
5711 FORMAT('FVS47 WARNING: A DEPRECATED BOARD-FOOT VOLUME ', &
       'COMPUTATION METHOD HAS BEEN REQUESTED.  ', &
       'METHOD CODE 6 (NATIONAL VOLUME ESTIMATOR LIBRARY) WILL BE ', &
       'USED BY DEFAULT.' )
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000
...
!                        ERROR NUMBER 48
5800 CONTINUE
WRITE(JOSTND,5810)  PREF
WRITE(CMSG,  5811)

5810 FORMAT(/A11,'FVS48 WARNING: A DEPRECATED CUBIC FOOT VOLUME ', &
       'COMPUTATION METHOD HAS BEEN REQUESTED.  ',/T12, &
       'METHOD CODE 6 (NATIONAL VOLUME ESTIMATOR LIBRARY) WILL BE ', &
       'USED BY DEFAULT.' )
5811 FORMAT('FVS48 WARNING: A DEPRECATED CUBIC FOOT VOLUME ', &
       'COMPUTATION METHOD HAS BEEN REQUESTED.  ', &
       'METHOD CODE 6 (NATIONAL VOLUME ESTIMATOR LIBRARY) WILL BE ', &
       'USED BY DEFAULT.' )
IF (ICCODE .LT. 2) ICCODE=1
...
!                        ERROR NUMBER 49
5900 CONTINUE
WRITE(JOSTND,5910)  PREF
WRITE(CMSG,  5911)

5910 FORMAT(/A11,'FVS49 WARNING: VOLUME KEYWORD HAS BEEN RECOGNIZED '/, &
       T12,'BUT HAS BEEN DEACTIVATED BY A PREVIOUS CALL TO USE FIAVBC ', &
       /T12,'FOR COMPUTATION OF CUBIC FOOT VOLUMES')
5911 FORMAT('FVS49 WARNING: VOLUME KEYWORD HAS BEEN RECOGNIZED ', &
       'BUT HAS BEEN DEACTIVATED BY A PREVIOUS CALL TO USE FIAVBC ', &
       'FOR COMPUTATION OF CUBIC FOOT VOLUMES')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000

!                        ERROR NUMBER 50 PREVENT DEFECT CALLS WHEN FIAVBC ACTIVE
6000 CONTINUE
WRITE(JOSTND,6010)  PREF
WRITE(CMSG,  6011)

6010 FORMAT(/A11,'FVS50 WARNING: DEFECT / MCDEFECT / MCFDLN KEYWORD ', &
       'HAS BEEN RECOGNIZED ',/T12, &
       'BUT HAS BEEN DEACTIVATED BY A PREVIOUS CALL TO USE FIAVBC ', &
       'FOR COMPUTATION OF CUBIC FOOT VOLUMES.',/T12, &
       'SETTING BOARD FOOT VALUES WITH DEFECT KEYWORD IS PERMITTED.')
6011 FORMAT('FVS50 WARNING: DEFECT / MCDEFECT / MCFDLN ', &
       'KEYWORD HAS BEEN RECOGNIZED ', &
       'BUT HAS BEEN DEACTIVATED BY A PREVIOUS CALL TO USE FIAVBC ', &
       'FOR COMPUTATION OF CUBIC FOOT VOLUMES. SETTING BOARD FOOT ', &
       'VALUES WITH DEFECT KEYWORD IS PERMITTED.')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000

!                        ERROR NUMBER 51 NOTIFY USER OF BOARD FOOT BFFDLN FUNCTION WHEN FIAVBC ACTIVE
6100 CONTINUE
WRITE(JOSTND,6110)  PREF
WRITE(CMSG,  6111)

6110 FORMAT(/A11,'FVS51 WARNING: BFFDLN KEYWORD HAS BEEN RECOGNIZED.', &
       /T12,'DUE A PREVIOUS CALL TO USE FIAVBC, ', &
       'BFFDLN WILL ONLY APPLY TO COMPUTATION OF BOARD FOOT VOLUMES', &
       /T12,'BUT WILL NOT AFFECT CUBIC SAWLOG VOLUMES')
6111 FORMAT('FVS51 WARNING: BFFDLN KEYWORD HAS BEEN RECOGNIZED. ', &
       'DUE A PREVIOUS CALL TO USE FIAVBC, BFFDLN WILL ONLY APPLY TO ', &
       'COMPUTATION OF BOARD FOOT VOLUMES BUT WILL NOT AFFECT CUBIC ', &
       'SAWLOG VOLUMES')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000

!                        ERROR NUMBER 52 NOTIFY USER OF FIAVBC DATABASE CALL WITHOUT FIAVBC CALL
6200 CONTINUE
WRITE(JOSTND,6210)  PREF
WRITE(CMSG,  6211)

6210 FORMAT(/A11,'FVS52 WARNING: USE OF DATABASE KEYWORDS ', &
       'VBCSUMDB, VBCTRLDB, VBCCUTDB, VBCATRDB', &
       /T12,'MUST INCLUDE USE OF BASE KEYWORD FIAVBC.')

6211 FORMAT('FVS52 WARNING: USE OF DATABASE KEYWORDS ', &
       'VBCSUMDB, VBCTRLDB, VBCCUTDB, VBCATRDB', &
       'MUST INCLUDE USE OF BASE KEYWORD FIAVBC.')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000

!                        ERROR NUMBER 53 NOTIFY USER OF INVALID ATTEMPT TO SET SCUFT MINHARVEST
6300 CONTINUE
WRITE(JOSTND,6310)  PREF
WRITE(CMSG,  6311)

6310 FORMAT(/A11,'FVS53 WARNING: INVALID ATTEMPT TO SET SCUFT IN ', &
       'MINHARV KEYWORD.  VALUE WILL BE IGNORED.')

6311 FORMAT('FVS53 WARNING: INVALID ATTEMPT TO SET SCUFT IN ', &
       'MINHARV KEYWORD.  VALUE WILL BE IGNORED.')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000

!                        ERROR NUMBER 54 NOTIFY USER OF INVALID SITE INDEX / SPECIES
6400 CONTINUE
WRITE(JOSTND,6410)  PREF
WRITE(CMSG,  6411)

6410 FORMAT( /A11,'FVS54 WARNING: INVALID SITE INDEX / SITE SPECIES ', &
       'CODE USED.  DEFAULT VALUE HAS BEEN USED')

6411 FORMAT('FVS54 WARNING: INVALID SITE INDEX / SITE SPECIES ', &
       'CODE USED.  DEFAULT VALUE HAS BEEN USED')
IF (ICCODE .LT. 2) ICCODE=1
GO TO 9000
