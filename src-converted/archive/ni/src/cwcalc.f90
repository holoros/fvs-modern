...
IMPLICIT NONE
!----------
! NI $Id: cwcalc.f 0000 2018-02-14 00:00:00Z gedixon $
!----------
!OMMONS
!
INCLUDE 'PRGPRM.f90'
...
!     &' ENTERING CWCALC: ISPC,CWEQN,VVER(:2)= ',ISPC,CWEQN,VVER(:2)
!      IF(DEBUG)WRITE(JOSTND,*)' ISPC,P,D,H,CR,IICR,CW,IWHO,JOSTND= ',
!     &ISPC,P,D,H,CR,IICR,CW,IWHO,JOSTND
!      IF(DEBUG)WRITE(JOSTND,*)' ISPC,IFOR,KODFOR= ',ISPC,IFOR,KODFOR
!----------
...
CASE('26403')
  ...
  ENDIF
!
!  CASE 26405 CROOKSTON (R6) MODEL 2
!  264          TSUGA MERTENSIANA                 MOUNTAIN HEMLOCK
CASE('26405')
  IF (EL .LT.  10.) EL= 10.
  IF (EL .GT.  79.) EL= 79.
