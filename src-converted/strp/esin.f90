...
IF (NUMBER.NE.1) THEN
   ...
   ELSE
!
!           IF THE NEWEST ESTAB KEYWORD CONTAINS A DATA OF DIST, THEN
...
!*    IF(IACTK.EQ.431) IF(LKECHO)WRITE(JOSTND,1230)
