...
!    OR KILLED BY FIRE DURING CYCLE
...
!
!     PAPER BIRCH (28) SET AT 0.3 SPROUTS/STUMP PER SILVIC OF N. AMERICA
!
!     ALLIGATOR JUNIPER (29) SET AT 1 SPROUT/STUMP PER JIM YOUTZ R3
!
!     CHIHUAHUA PINE (36) SET AT 2 SPROUTS/STUMP PER JIM YOUTZ R3
!----------
...
NORMHT(ITRN)=0
!----------
!  CALCULATE DBH AND HEIGHT OF SPROUTS
!----------
