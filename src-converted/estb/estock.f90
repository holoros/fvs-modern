...
!
!     COEFFICIENTS FOR SITE PREP BY HABITAT TYPE SERIES
!     SITE PREP--> NONE     MECH     BURN
!
...
60 CONTINUE
!
!     P(STOCKING) CEDAR AND HEMLOCK SERIES.      4/28/89
!
...
80 CONTINUE
!
!     P(STOCKING) SUBALPINE FIR SERIES.
!
