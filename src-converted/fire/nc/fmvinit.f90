...
POTEMP(2)=70.
!
!     NC DECAY RATES BASED ON NC DESIGN WORKSHOP (NOTES FROM
!     STEPHANIE REBAIN, 2003) EACH VARIANT MAY USE DIFFERENT
!     RATES AND CITE DIFFERENT DATA SOURCES
!
!     DECAY RATES IN THE NC ARE SUBSEQUENTLY MODIFIED BY A
!     MULTIPLIER BASED ON DUNNING-CODE (SEE NC **FMCBA**)
!
DKR(1,1) =  0.025   ! < 0.25"
