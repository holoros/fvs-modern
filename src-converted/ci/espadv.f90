...
! CI $Id$
!----------
!   PREDICT PROBS OF ADVANCE SPECIES.
!----------
!OMMONS
!
!
...
PADV(5)=(1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,5)   *XESMLT(5) &
      *OCURNF(IFO,5)
!----------
!     P(ADVANCE WESTERN REDCEDAR) 3/19/87
!----------
...
PADV(6)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,6)  *XESMLT(6) &
      *OCURNF(IFO,6)
!----------
!     P(ADVANCE LODGEPOLE PINE). 3/25/87
!----------
IF(IPREP.LE.3) THEN
...
ENDIF
!----------
!     P(ADVANCE ENGELMANN SPRUCE)   10/03/89
!----------
...
PADV(8)= (1.0/(1.0+EXP(-PN))) * OCURHT(IHAB,8)  *XESMLT(8) &
      *OCURNF(IFO,8)
!----------
!     P(ADVANCE SUBALPINE FIR)   9/13/89
!----------
IF(IPREP.LE.3) THEN
...
ENDIF
!----------
!     P(ADVANCE PONDEROSA PINE) 3/24/87
!----------
IF(IPREP.LE.3) THEN
...
ENDIF
!----------
!     P(ADVANCE WHITEBARK PINE)
!----------
PADV(11)=0.0
!----------
!     P(ADVANCE PACIFIC YEW)
!----------
PADV(12)=0.0
!----------
!     P(ADVANCE QUAKING ASPEN)
!----------
PADV(13)=0.0
!----------
!     P(ADVANCE WESTERN JUNIPER)
!----------
PADV(14)=0.0
!----------
!     P(ADVANCE CURLLEAF MOUNTAIN-MAHOGANY)
!----------
PADV(15)=0.0
!----------
!     P(ADVANCE LIMBER PINE)
!----------
PADV(16)=0.0
!----------
!     P(ADVANCE BLACK COTTONWOOD)
!----------
PADV(17)=0.0
!----------
!     P(ADVANCE OTHER SOFTWOODS)
!----------
PADV(18)=0.0
!----------
!     P(ADVANCE OTHER HARDWOODS)
!----------
PADV(19)=0.0
!
RETURN
