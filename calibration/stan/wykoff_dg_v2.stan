// Bayesian Wykoff Diameter Growth Model for FVS Calibration (v2)
// Fixes: lower bound on sigma to prevent zero-scale proposals
...
parameters {
  ...
  real<lower=0.01> sigma_b0;         // SD of species intercepts (bounded away from 0)
  ...
  real<lower=0.001> sigma;           // Observation error SD (bounded away from 0)
}
