...
! EM $Id$
!----------
!     PREDICT THE PROBABILITY OF EXCESS SPECIES
!----------
!
!OMMONS
!
...
!----------
!
!     PROB OF EXCESS WHITEBARK PINE (USE NI WP)
!
...
!
!     PROB OF EXCESS WESTERN LARCH (USE NI WL)
!
...
!
!     PROB OF EXCESS DOUGLAS-FIR (USE NI DF)
!
...
!
!     PROB OF EXCESS LIMBER PINE (USE IE LM)
!
PXCS(4)=0.
!
!     PROB OF EXCESS SUBALPINE LARCH (USE IE AF)
!
...
!
!     PROB OF EXCESS ROCKY MTN JUNIPER (USE IE JU)
!
PXCS(6)=0.
!
!     PROB OF EXCESS LODGEPOLE PINE (USE NI LP)
!
...
!
!     PROB OF EXCESS ENGELMANN SPRUCE (USE NI ES)
!
...
!
!     PROB OF EXCESS SUBALPINE FIR (USE NI AF)
!
...
!
!     PROB OF EXCESS PONDEROSA PINE (USE NI PP)
!
...
PXCS(10)=(1.0/(1.0+EXP(-PN)))*XESMLT(10)*OCURHT(IHAB,10) &
       *OCURNF(IFO,10)
!
!     PROB OF EXCESS ANY OTHER SPECIES
!
PXCS(11)=0.0
PXCS(12)=0.0
PXCS(13)=0.0
