...
#SBATCH --output=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/ablation_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fvs-modern/calibration/logs/ablation_%j.err
