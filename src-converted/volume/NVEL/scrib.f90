...
!     DIA-REAL  LEN-REAL COR-CHAR  VOL-REAL

!     COMPUTES SCRIBNER BOARD FOOT VOLUME USING FACTORS AND
!     MAKING CORRECTIONS TO THE FACTOR VOLUMES IF DESIRED

!     COR - FLAG FOR FACTOR OR CORRECTED FACTOR VOLUMES
!     DIA - DIAMETER CLASS OF LOG
!     EXCEPT - EXCEPTIONS BETWEEN FACTOR AND SCRIBNER VOLUMES
!     FACTOR - FACTORS USED TO GENERATE SCRIBNER VOLUME
!     LEN - LENGTH OF LOG NOT INCLUDING TRIM
!     VOL - SCRIBNER DECIMAL C VOLUME (10 BDFT)
...
!   COMMENTED OUT AS IT IS ONLY NECESSARY WHEN CHECKING FACTORS
...
!     COEFFICIENTS FOR FACTOR VOLUMES
...
!    EXCEPTION TO FACTOR VOLUMES
!     FIRST 2 POSITIONS ARE LENGTH NEXT 3 ARE DIAMETER
!       IF EXCEPTION IS ODD ADD 1 BDFT
!       IF EXCEPTION IS EVEN SUBTRACT 1 BDFT
...
!   WRITE OUT FACTORS USED TO GENERATE SCRIBNER VOLUME

!      WRITE (2,10) NEWPG
!  10   FORMAT (A1,'   FACTORS FOR COMPUTING SCRIBNER ',
!    >   'BOARD FOOT LOG VOLUMES',/,10X,'DIA = INSIDE ',
!    >  ' BARK SMALL END DIAMETER',/)
!      WRITE (2,15) (I,FACTOR(I),I=1,120)
!  15  FORMAT ( 5(4X,'DIA',1X,' FACTOR',),/,
!    >         24( 5(4X,I3,1X,F7.3),/ ))
!      WRITE (2,20)
!  20  FORMAT (/,'   FACTORS FOR LOGS 16 FT. THROUGH',
!    >  ' 31 FT. IN LENGTH',/)
!      WRITE (2,25) (I,FACTOR(I+115),I=6,11)
!  25  FORMAT ( 6(4X,'DIA',1X,' FACTOR',),/,
!    >       6(4X,I3,1X,F7.3),/ )
!      WRITE (2,30)
!  30  FORMAT (/,'   FACTORS FOR LOGS 32 FT. THROUGH',
!    >  ' 40 FT. IN LENGTH',/)
!      WRITE (2,35) (I,FACTOR(I+121),I=6,11)
!  35  FORMAT ( 6(4X,'DIA',1X,' FACTOR',),/,
!    >        6(4X,I3,1X,F7.3),/ )

!   WRITE OUT EXCEPTIONS TO FACTOR VOLUMES

!      WRITE (2,40)
!  40  FORMAT (/,'   EXCEPTIONS TO THE FACTOR GENERATED ',
!    >  'VOLUMES - 40420 IS A 4 FT. LONG LOG WITH A 42 ',
!    >  'INCH DIA.',/,3X,'IF THE NUMBER ENDS IN 0 SUBTRACT 1 ',
!    >  'FROM THE FACTOR VOLUME, IF IT ENDS IN 1 ADD 1 ',
!    >  'TO THE FACTOR VOLUME.',/)
!      WRITE (2,45) (EXCEPT(I),I=1,132)
!  45  FORMAT ( 13(10(3X,F7.0),/ ),3X,F7.0,3X,F7.0)
...
!  46     FORMAT(A24)
  ...
  IF(DIA .LT. 1) THEN
     ...
     RETURN
  ENDIF
!     set maximum small end diameter
...
!  FIX EXCEPTIONS TO FACTOR VOLUMES
...
!    ----------- end of INTERNATIONAL 1/4 routine
  RETURN
  END
