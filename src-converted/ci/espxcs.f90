...
!----------
!  P(EXCESS WESTERN WHITE PINE)  3/24/87
!----------
...
!----------
!  P(EXCESS WESTERN HEMLOCK) 3/20/87
!----------
...
!----------
!  P(EXCESS WESTERN REDCEDAR). 3/26/87
!----------
...
!----------
!  P(EXCESS ENGELMANN SPRUCE). 04/08/87
!----------
...
PXCS(10)=(1.0/(1.0+EXP(-PN)))*XESMLT(10)*OCURHT(IHAB,10) &
       *OCURNF(IFO,10)
!----------
!  P(EXCESS WHITEBARK PINE)
!----------
PXCS(11)=0.0
!----------
!  P(EXCESS PACIFIC YEW)
!----------
PXCS(12)=0.0
!----------
!  P(EXCESS QUAKING ASPEN)
!----------
PXCS(13)=0.0
!----------
!  P(EXCESS WESTERN JUNIPER)
!----------
PXCS(14)=0.0
!----------
!  P(EXCESS CURLLEAF MOUNTAIN-MAHOGANY)
!----------
PXCS(15)=0.0
!----------
!  P(EXCESS LIMBER PINE)
!----------
PXCS(16)=0.0
!----------
!  P(EXCESS BLACK COTTONWOOD)
!----------
PXCS(17)=0.0
!----------
!  P(EXCESS OTHER SOFTWOODS)
!----------
PXCS(18)=0.0
!----------
!  P(EXCESS OTHER HARDWOODS)
!----------
PXCS(19)=0.0
!
RETURN
