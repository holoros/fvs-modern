...
! VLS $Id$
!----------
!  CALLED FROM INTREE, WHEN THE INPUT SPECIES CODE IS NOT RECONGIZED.
...
!  REGIONAL CONTACTS. TO PROVIDE ADEQUATE CODE DOCUMENTATION,
...
!  IF SPECIES CODE WAS NOT SET, RETURN NON COMMERCIAL (CS, LS, NE VARIANTS)
!  OR OTHER TREE (SN VARIANT)
!----------
ISPC1= 0
