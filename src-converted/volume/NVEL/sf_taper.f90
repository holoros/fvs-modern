...
!             calculater taper coefficients, given geometric properties
!           this is step 4 of application;  calculate taper coefficients
...
!                 Upper Segment                  Appendix A, Eqns A1 thru A4
!                      (note: k is an arbitrary positive constant.
!                            changing it will affect some parameters,
!                            but will not affect predicted tree form.)
  K = 1.0
...
!                 Middle Segment                 Appendix A, Eqns A6 thru A15
...
!                            straight segment at inflections
...
!                 Lower Segment            Appendix A, Eqns A16 thru A26
  S3 = -SLOPE_RHI * RHI1
  K2 =S3/R1
