...
! DBS $Id$
!
!     PURPOSE: POPULATES A DATABASE TABLE WITH WWPBM OUTPUT
!              PERTAINING TO VOLUME-BY-SIZE-CLASS.
!     AUTH: AJ MCMAHAN -- ITX, INC. SEPT. 2005
!     INPUT:
!     TVOL  ARRAY HOLDING STAND VOLUME BY WWPBM-SIZE CLASS
!     HVOL  ARRAY HOLDING STAND HOST VOLUME BY WWPBM-SIZE CLASS
!     VOLK  ARRAY HOLDING VOLUME BEETLE-KILLED BY WWPBM-SIZE CLASS
!
!---
!OMMONS
!
...
ENDIF
!---------
!     CHECK TO SEE IF THE WWPBM VOLUME BY SIZE CLASS TABLE EXISTS IN DB
!---------
