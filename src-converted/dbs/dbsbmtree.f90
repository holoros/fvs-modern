...
!              REPORTED BY TREE SIZE CLASS (SC)
!     AUTH: AJ MCMAHAN -- ITX, INC. SEPT. 2005
!     INPUT:
!
!     TPA:      TREES PER ACRE (TPA) IN EACH SIZE CLASS (BEGINNING OF YR)
!     TPAH:     TPA HOST BY SIZE CLASS (@ BEGINNING OF YEAR)
!     TPAKLL:   TPA BEETLE-KILLED BY SIZE CLASS (DURING THIS YEAR)
!     SPCLTRE:  TPA OF WWPBM "SPECIAL" TREES (BEGINNING OF YEAR)
!     SAN1(-10):LIVE, UNATTACKED TPA REMOVED VIA SANITATION CUTS THIS YR
!     NSCL:     # WWPBM SIZE CLASSES (CURRENTLY =10)
!     CID: CASE ID FROM THE FVSCases TABLE
!
!---
!OMMONS
!
...
ENDIF
!---------
!     CHECK TO SEE IF THE WWPBM "TREEOUT" TABLE EXISTS IN DATBASE
!---------
