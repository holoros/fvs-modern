...
!  CONSTANTS.
!  SDI BASED MORTALITY IS ALWAYS USED. ADDITIONAL MORTALITY OCCURS WHEN
!  STAND BA EXCEEDS THE SPECIFIED MAXIMUM BA FOR THE SITE.  IF
...
INTEGER I1,I2,I3,IS,IPATH,KNT2,ISPC,ITODO,IP
...
!
! SHADE TOLERANCE LEVELS (SEE **HTGF** AND **VARMRT**):
!   VERY TOLERANT: 4=SF,  5=RC, 11=WH, 13=PY, 25=DG
!                  USE SF FOR WH; USE RC FOR PY AND DG
!        TOLERANT: 6=GF,  8=ES,  9=AF, 16=WF, 18=YC
!                  USE GF FOR WF AND YC
!    INTERMEDIATE: 1=WP,  3=DF, 12=MH, 14=WB, 15=NF, 24=GC, 28=WO, 31=OS
!                  USE WP FOR WB, NF, GC, WO; OS FOR MH
!      INTOLERANT:10=PP, 19=WJ, 22=RA, 23=PB, 29=PL
!                  USE PP FOR WJ, RA, PB, PL
! VERY INTOLERANT: 2=WL,  7=LP, 17=LL, 20=BM, 21=VN, 26=AS, 27=CW, 30=WI, 32=OH
!                  USE LP FOR LL, BM, VN, AS, CW, WI, OH
!----------
DATA PMSC/
...
DATA PMD/
     ...
     & -.0077681, -.0340128/
!----------
!  DR0     = START OF CYCLE REINEKE'S DIAMETER
...
!  DR10    = REINEKE'S DBH AT END OF CYCLE IF TREES/ACRE IS HELD CONSTANT
...
!
!***********************************************************************
!  THIS SECTION OF CODE IS NEEDED FOR SPECIES USING EC VARIANT LOGIC:
!
