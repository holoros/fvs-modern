...
!----------
!  THESE ARE THE WESTSIDE (PN/WC) SPECIES GROUPS (1 - 15) TO USE FOR SNAG HEIGHT LOSS
!----------
DATA (WSSPEC(I), I= 1, 39) / &
    ...
    15, 15, 15,  6,  6,  6,  6,  6,  1,  3, &
     2,  7,  1,  6,  6,  6,  6,  6,  6/
!----------
!  THESE ARE THE BM SPECIES GROUPS (1 - 15) TO USE FOR SNAG HEIGHT LOSS
!----------
DATA (BMSPEC(I), I= 1, 18) / &
     2,  3,  4, 12, 10,  1,  7,  8, 13,  5, &
     2,  2,  1,  1,  6,  6,  5,  6/
!----------
!  THESE ARE THE EC SPECIES GROUPS (1 - 15) TO USE FOR SNAG HEIGHT LOSS
!----------
DATA (ECSPEC(I), I= 1, 32) / &
    ...
    10,  6/
!----------
!  THESE ARE THE SO SPECIES GROUPS (1 - 15) TO USE FOR SNAG HEIGHT LOSS
!----------
...
END SELECT
!----------
!  DETERMINE THE AMOUNT OF HEIGHT LOSS.
!----------
X = 0.0
CALL RANN(Y)
