...
! SPECIES: YC, DF, RW, RC, BM, WA, PB, GC, AS, CW, WJ, WB, KP, PY, DG,
!           HT, CH, WI, OT
!----------
...
!----------
! INCENSE CEDAR - BARRETT, PNW 232 (JEFFERY & PONDEROSA)
! PONDEROSA PINE USE BARRETT
! SPECIES: IC, JP, PP
!----------
CASE(9,12,15)
