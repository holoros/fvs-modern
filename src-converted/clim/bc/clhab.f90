...
!----------
!
!     CLIMATE EXTENSION -- ASSIGNS DEFAULT MEAN ANNUAL TEMPERATURE BASED
!     ON HABITAT ZONE, WHEN ACTUAL CLIMATE DATA ARE NOT FOUND; USED TO
!     MODIFY CWD DECAY RATES FOR FFE
!
!OMMONS
...
!     Structure and data for default Mean Annual Temperature
!     Reference = Historical values
!     Provided by Tongli Wang, UBC, 1-Feb-2010
!     Some of these matches may not work properly: e.g.
!     >  CLIM_DEFAULT_STR('ESSFxc',    1.258695652),
!     >  CLIM_DEFAULT_STR('ESSFxc1',   1.393015873),
!     if the input strings aren't correctly sized
...
!     SET MAT BASED ON HISTORICAL BEC VALUES (CELSIUS)
