...
!.... Parameter statements for numeric variable processing.
INTEGER MXI,MXL,MXR
...
!.... Put the real scalars.

REALS (1) = DMRMIN
CALL BFWRIT (WK3, IPNT, ILIMIT, REALS, MXR, 2)

!.... Put the integer scalars.
...
!.... Put the arrays.
!.... Note that MISCYC, PRFMST, PMCSP, and DGPDMR are 2-d arrays.
...
IMPLICIT NONE
!----------
!  **MSCHPUT--MS  DATE OF LAST REVISION:  07/10/15
!----------
!  Purpose:
!     Put (store) the mistletoe model character data for a stand.
!  This is part of the Stop/Restart utility.
!
!
!OMMONS
!
...
!.... Parameter statements for character variable processing.
INTEGER LNCBUF
CHARACTER CBUFF(LNCBUF)
INTEGER I,IPNT,J

!      write(*,*) 'in MSCHPUT:', IPNT
