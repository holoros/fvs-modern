...
! ENTER WITH COMPUTED DIBS FOR 1 TO 20 LOGS IN A TREE.
! RETURN WITH GROSS BD-FT AND CU-FT VOLUME FOR EACH LOG.
! USE SCRIBNER DIAMETER-LENGTH FACTORS FOR COMPUTING BD-FT SCALE.
! MINIMUM LOG DIB = 2 INCHES.
! MAXIMUM LOG DIB = 120 INCHES.
! EASTSIDE:
!   XLOGS = NUMBER OF 16-FT LOGS TO NEAREST HALF
!   COMPUTE 16-FT SCALE FOR WHOLE LOGS.
!   COMPUTE 8-FT SCALE FOR ANY HALF LOG AT THE TOP.
!   A SINGLE HALF LOG IN THE TREE IS NOT PERMITTED.
! WESTSIDE:
!   XLOGS = NUMBER OF 16-FT LOGS
!   COMPUTE 16-FT EQUIVALENTS OF 32-FT SCALE FOR ALL WHOLE LOGS.
!   COMPUTE STRAIGHT 16-FT SCALE FOR ANY HALF LOG IN THE TREE.
...
!     ***** SCRIBNER DIAMETER-LENGTH FACTORS *****
! IFTR(1-5)     APPLY TO ALL LOG LENGTHS WITH DIB (1-5)
! IFTR(6-17)    APPLY ONLY TO 16-FT LOGS WITH DIB (6-11 )
! IFTR(12-17)   APPLY ONLY TO 32-FT LOGS WITH DIB (6-11)
! IFTR(18-126)  APPLY TO ALL LOG LENGTHS WITH DIB (12-120)
! IFTR(127-132) APPLY ONLY TO  8-FT LOGS WITH DIB (6-11)
...
!     ***** GET 16-FT SCALE FOR BOTH HALFS OF LOG *****
...
!     ***** GET 32-FT SCALE FOR ENTIRE LOG *****
  KD = LOGDIA(I+1,1)
  K = KTOP
...
!     ***** PROPORTIONATE 32-FT SCALE BY LOG HALFS *****
  ITOPGV = IV32 * R + 0.5
  IBOTGV = IV32 - ITOPGV
  LOGVOL(1,I+1) = ITOPGV
...
!     ***** SINGLE 16-FT LOG (TOP OR BUTT OF TREE) *****
30 IBOTGV = BOTV16
  LOGVOL(1,I) = IBOTGV
