...
! SN $Id$
!----------
!  THIS SUBROUTINE COMPUTES THE PREDICTED PERIODIC HEIGHT INCREMENT
...
!----------
!   SET COEFFICIENTS AND SITE INDEX FOR SPECIES
!----------
B1= LTBHEC(1,ISPC)
B2= LTBHEC(2,ISPC)
B3= LTBHEC(3,ISPC)
...
SI= SITEAR(ISPC)
!----------
!  CHECK FOR NONMOUNTAIN YELLOW POPLAR SPECIES, WHICH REQUIRES
!  A SPECIFIC SET OF COEFICIENTS DIFFERENT THAN MOUNTAIN YP
!----------
...
HB= 0.
!----------
!  CALCULATE MAXIMUM HIGHT FOR SPECIES, IF CURRENT TREE HEIGHT
!  H >= HTMAX THEN RETURN
!----------
HTMAX=(B1*SI**B2)
...
!  EVALUATED FOR EACH TREE EACH CYCLE (5. YEAR STANDARD CYCLE LENGTH)
!-----------
