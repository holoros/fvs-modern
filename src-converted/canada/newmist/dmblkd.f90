...
! CANADA-NEWMIST $Id$
!----------
!  **DMBLKD  DATE OF LAST REVISION:  02/15/96
!----------
! Purpose:
!   An immense data statement that assigns all the precomputed
! trajectory information, and a matrix of pointers to grid cell
