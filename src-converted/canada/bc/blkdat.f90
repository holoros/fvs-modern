...
!
!
!     birch,aspen,cottonwood - from B. Snowdon: LS uses 0.94, 0.92, 0.93
!
INTEGER I,J
!
DATA  BKRAT/MAXSP*0./
...
!     &         118,109,111,112,412,402,  0,  0,  0,  0/,
!     &  IFORST / 3,  4,  5,  4,  7, 10,  4, 14, 16, 17,
!     &           4,  9, 11, 12, 19, 20,  4,  4,  4,  4/
!
...
!     - SET to 0; NOT USED IN STRP VERSION
!
...
!     8 = ENGELMANN SPRUCE (ES)       [SE] ! aka SX
!     9 = SUBALPINE FIR (AF)          [BL]
!    10 = PONDEROSA PINE (PP)         [PY]
!    11 = BIRCH (PB)                  [EP] 24 in WC
!    12 = ASPEN (AS)                  [AT] 26 in WC
!    13 = COTTONWOOD (CW)             [AC] 27 in WC
...
!
!
!     HT FOR EP,AT,AC TAKEN FROM WC-VARIANT
!
DATA HT1/ &
...
!
!     BEC-SPECIFIC RESIDUAL ERROR ESTIMATES ARE PROVIDED
!     IN **DGF**
!
   de by two here, rather than in DGF; otherwise sequential &
    break down
 DATA SIGMAR/ &
