...
IMPLICIT NONE
!----------
!   **FMCFMD FIRE-NI-DATE OF LAST REVISION: 07/15/03
!----------
...
!
!     SEE WHICH FUEL MODELS ARE ACTIVE. THE AMOUNT OF SMALL AND LARGE FUEL
!     PRESENT CAN MODIFY THE CHOICE OF MODEL, AS CAN THE HABITAT TYPE OR
!     WHEN THE LAST HARVEST ACTIVITY WAS DONE.
!     FROM FAX FROM ELIZABETH REINHARDT
!
!     THE ORIGINAL RULE FROM J.BROWN WAS:
!       FMD = 9
!       IF (PERCOV .LE. 40.0) FMD = 1
!     HOWEVER, IT HAS BEEN ENHANCED WITH THE FOLLOWING CODE:
!
IDRY = 0
CALL NIFMHAB(IDRY)
