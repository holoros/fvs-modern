...
!  or PBSMAL equals 1, which may often be the case.  So it's done here.
!----------
...
!----------
!  Reduce base rate for larger spruce and larger larch.
!  Marcot's eqn is too fast (20 yrs @ 15 in DBH vs 95 yrs @ 24 in DBH)
!----------
