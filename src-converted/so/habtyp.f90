...
IF(DEBUG) WRITE(JOSTND,*) &
   'ENTERING HABTYP CYCLE,KODTYP,KODFOR,ARRAY2,CPVREF= ', &
   ICYC,KODTYP,KODFOR,ARRAY2,CPVREF
!----------
!  IF FOREST CODE HAS ALREADY BEEN SET, SET REGION FLAG.
!  INDUSTRY CODE 701 TREATED AS R5 FOREST TO BE CONSISTENT WITH
!  PREVIOUS DEFAULTS.
!  WARM SPRINGS (799) TREATED AS A R6 FOREST
!----------
IR5=0
IR6=0
IF(KODFOR .GT. 0) THEN
...
ENDIF
!----------
!     DEFAULT CONDITIONS ---- PA  CPS111   SITE SPECIES=PP  SI=70
!----------
IF (KODTYP.EQ.0) THEN
